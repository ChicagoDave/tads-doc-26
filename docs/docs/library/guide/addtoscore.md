...
Finally, note that the second parameter in addToScore may be an [Achievement](achievement.md) object instead of a single-quoted string. We'll explain this in more detail once we've introduced the Achievement class.
