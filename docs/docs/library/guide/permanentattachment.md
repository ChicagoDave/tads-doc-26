...
PermanentAttachment : [Attachable](attachable.md)
...
One way of setting up a PermanentAttachment relationship is to make both the objects PermamentAttachments and add one to the attachedObjects property of the other, for example:
...
;
bracket : RoomPartItem, PermanentAttachment, Decoration 'steel bracket' 'steel bracket' @mainCave
