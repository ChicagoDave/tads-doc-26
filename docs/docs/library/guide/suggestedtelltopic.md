...
SuggestedTellTopic : [SuggestedTopic](suggestedtopic.md)

A SuggestedAskTopic is the particular type of [SuggestedTopic](suggestedtopic.md) that prompts the player to Tell About such-and-such a thing.
