...
Switch : [OnOffControl](onoffcontrol.md)

Switch is a simple extension of the generic [OnOffControl](onoffcontrol.md) that can be used with a SWITCH command without specifying ON or OFF, and treats FLIP synonymously. SWITCH X or FLIP X thus turns X on if it was off and vice versa.
