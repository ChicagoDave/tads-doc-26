...
TCommandTopic : [CommandTopic](commandtopic.md)

Having overridden [ActorState.obeyCommand](overridingobeycommand.md) to make it easier for CommandTopics to handle commands with a direct object, the next step is to define a CommandTopic subclass that takes advantage of these changes. We'll call it TCommandTopic, for a topic that handles a TAction.
...
**>sarah, cut case with banana**"Sarah, would you cut the display case with the Golden Banana of Discord, please?" you ask her.
...
**>sarah, take banana**You won't let Sarah have that. Sarah takes the Golden Banana of Discord and turns it over in her hands. "That's interesting!" she says.
...
**>woman, take banana**Sarah takes the Golden Banana of Discord and turns it over in her hands. "That's interesting!" she says.
