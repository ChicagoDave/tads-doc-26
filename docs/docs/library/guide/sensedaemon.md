...
SenseDaemon : [Daemon](daemon.md)

A SenseDaemon, like a [SenseFuse](sensefuse.md), is for use when you want players to see its output only when a certain object can be sensed.
...
We'll create an example of a SenseDaemon when we come to [CyclicEventList](cycliceventlist.md).
