...
MiscTopic : [TopicEntry](topicentry.md)

MiscTopic is the parent class of TopicEntry types such as [ByeTopic](byetopic.md), [HelloTopic](hellotopic.md), [YesTopic](yestopic.md) and [NoTopic](notopic.md) that respond to simple command such as HELLO, BYE, YES and NO without referring to any further object or topic (you don't HELLO SARAH ABOUT FISH as you might ASK SARAH ABOUT FISH, for example).
