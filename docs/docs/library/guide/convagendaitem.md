...
ConvAgendaItem : [AgendaItem](agendaitem.md)
...
The main thing to note about a ConvAgendaItem is that the only way it differs from a standard AgendaItem is by overriding the isReady property
