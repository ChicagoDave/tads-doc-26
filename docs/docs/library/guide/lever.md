...
Lever : [Thing](thing-thebasics.md)
...
We'll give [yet another example of a lever](lever%282%29.md) when we're ready for it. To tidy up this part of the game, we need to create the temple and the connections between various locations. To start with we'll create the routes to the grotto and the temple from the shore of the lake:
