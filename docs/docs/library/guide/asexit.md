...
Once again, the new properties to be added are shown in bold. Note that we point the south property not to another room, but to the previously defined [RoomConnector](roomconnector.md), entranceTunnel.
