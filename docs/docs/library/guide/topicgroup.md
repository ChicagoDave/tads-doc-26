...
Note that in this case, if any of these individual actor states have [DefaultTopics](defaulttopics-overview.md) that might mask bob and dora, these actor states would need to define `excludeMatch = [bob, dora].`
