...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 953)


Show the current score.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ScoreActionSubclasses:** [predicate(Score)](predicate%28score%29.md)
