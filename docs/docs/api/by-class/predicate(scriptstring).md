...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9931)


**Superclass chain:** [ScriptStringAction](scriptstringaction.md) > [ScriptAction](scriptaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(ScriptString)**
...
Defined in en_us.t, line 9934


## Inherited Properties


*From [ScriptAction](scriptaction.md):* [`fileDisposition`](scriptaction.md#fileDisposition), [`filePromptMsg`](scriptaction.md#filePromptMsg), [`fileTypeID`](scriptaction.md#fileTypeID)
...
*From [ScriptStringAction](scriptstringaction.md):* [`execSystemAction`](scriptstringaction.md#execSystemAction)


*From [ScriptAction](scriptaction.md):* [`performFileOp`](scriptaction.md#performFileOp), [`setUpScripting`](scriptaction.md#setUpScripting), [`showCancelMsg`](scriptaction.md#showCancelMsg)
