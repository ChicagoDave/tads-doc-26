...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10080)


**Superclass chain:** [JumpAction](jumpaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Jump)**
...
*From [JumpAction](jumpaction.md):* [`execAction`](jumpaction.md#execAction)
