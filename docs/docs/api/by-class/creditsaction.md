...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1082)


Show the credits for the game and the library modules the game includes.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **CreditsActionSubclasses:** [predicate(Credits)](predicate%28credits%29.md)
...
Defined in actions.t, line 1091
...
Defined in actions.t, line 1083
