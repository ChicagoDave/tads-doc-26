...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10020)


**Superclass chain:** [StarboardAction](starboardaction.md) > [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Starboard)**
...
Defined in en_us.t, line 10024


## Inherited Properties


*From [StarboardAction](starboardaction.md):* [`getDirection`](starboardaction.md#getDirection)
