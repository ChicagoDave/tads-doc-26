...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10410)


**Superclass chain:** [PourOntoAction](pourontoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PourOnto)**
...
Defined in en_us.t, line 10414


### `verbPhrase`

Defined in en_us.t, line 10413
