...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2313)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **DigWithActionSubclasses:** [predicate(DigWith)](predicate%28digwith%29.md)
...
Defined in actions.t, line 2315
