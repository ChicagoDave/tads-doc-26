...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3006)


A TELL ABOUT topic database entry. This type of topic entry is included in the TELL ABOUT list only.


**Superclass chain:** [AskTellTopic](asktelltopic.md) > [TopicMatchTopic](topicmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **TellTopic**
