...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9889)


**Superclass chain:** [RestartAction](restartaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Restart)**
...
Defined in en_us.t, line 9892


## Inherited Properties


*From [RestartAction](restartaction.md):* [`includeInUndo`](restartaction.md#includeInUndo)
...
*From [RestartAction](restartaction.md):* [`doRestartGame`](restartaction.md#doRestartGame), [`execSystemAction`](restartaction.md#execSystemAction)
