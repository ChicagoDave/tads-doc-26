...
*object* — defined in [lister.t](../by-file/lister.t.md) (line 1468)


Plain lister for actors. This is the same as an ordinary plainLister, but ignores each object's isListed flag and lists it anyway.


**Superclass chain:** [plainLister](plainlister.md) > [Lister](lister.md) > `object` > **plainActorLister**
...
Defined in lister.t, line 1469


## Inherited Methods


*From [plainLister](plainlister.md):* [`showListPrefixTall`](plainlister.md#showListPrefixTall), [`showListPrefixWide`](plainlister.md#showListPrefixWide), [`showListSuffixWide`](plainlister.md#showListSuffixWide)
