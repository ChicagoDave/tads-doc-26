...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10049)


**Superclass chain:** [EnterAction](enteraction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Enter)**
...
Defined in en_us.t, line 10055


### `verbPhrase`

Defined in en_us.t, line 10054
