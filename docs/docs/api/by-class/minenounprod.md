...
*class* — defined in [parser.t](../by-file/parser.t.md) (line 2754)


**Superclass chain:** [PossessivePronounNounProd](possessivepronounnounprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **MineNounProdSubclasses:** [possessiveNounPhrase(mine)](possessivenounphrase%28mine%29.md)
