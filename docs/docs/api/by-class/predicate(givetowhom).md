...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9610)


**Superclass chain:** [GiveToAction](givetoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(GiveToWhom)**
...
Defined in en_us.t, line 9614


## Inherited Methods


*From [GiveToAction](givetoaction.md):* [`getDefaultIobj`](givetoaction.md#getDefaultIobj)
