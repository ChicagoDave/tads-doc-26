...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1987)


**Superclass chain:** [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **HelloActionSubclasses:** [predicate(Hello)](predicate%28hello%29.md)
...
Defined in actions.t, line 1988
