...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9430)


**Superclass chain:** [AskForAction](askforaction.md) > [ConvTopicTAction](convtopictaction.md) > [TopicTAction](topictaction.md) > [TopicActionBase](topicactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(AskFor)**
...
Defined in en_us.t, line 9436


### `askIobjResponseProd`

Defined in en_us.t, line 9437


### `omitIobjInDobjQuery`

Defined in en_us.t, line 9435


### `verbPhrase`

Defined in en_us.t, line 9434
