...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1995)


the issuing actor is saying hello to the target actor


**Superclass chain:** [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **GoodbyeActionSubclasses:** [predicate(Goodbye)](predicate%28goodbye%29.md)
...
Defined in actions.t, line 1996
