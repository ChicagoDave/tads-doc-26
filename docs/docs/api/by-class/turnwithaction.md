...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2366)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **TurnWithActionSubclasses:** [predicate(TurnWith)](predicate%28turnwith%29.md)
...
Defined in actions.t, line 2368
