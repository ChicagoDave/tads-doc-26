...
*class* — defined in [objects.t](../by-file/objects.t.md) (line 1683)


A default topic entry for a consultable. You can include one (or more) of these in a consultable's database to provide a topic of last resort that answers to any topics that aren't in the database themselves.


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultConsultTopic**
...
Defined in objects.t, line 1684


## Inherited Properties


*From [DefaultTopic](defaulttopic.md):* [`excludeMatch`](defaulttopic.md#excludeMatch), [`matchScore`](defaulttopic.md#matchScore)
...
Defined in objects.t, line 1685


## Inherited Methods


*From [DefaultTopic](defaulttopic.md):* [`isMatchPossible`](defaulttopic.md#isMatchPossible), [`matchTopic`](defaulttopic.md#matchTopic)
