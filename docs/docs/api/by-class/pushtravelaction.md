...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2894)
...
**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **PushTravelAction**


<details><summary>Subclasses (29)</summary>
...
Defined in actions.t, line 2912
