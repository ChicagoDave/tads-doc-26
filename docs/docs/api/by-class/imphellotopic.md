...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3319)


An implied greeting topic. This handles ONLY implied greetings.


**Superclass chain:** [MiscTopic](misctopic.md) > [TopicEntry](topicentry.md) > `object` > **ImpHelloTopic**
...
Defined in actor.t, line 3320


### `matchList`

Defined in actor.t, line 3321


### `matchScore` *(overridden)*

Defined in actor.t, line 3322
