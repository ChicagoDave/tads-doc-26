...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3699)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultAskTellTopic**
...
Defined in actor.t, line 3700


### `matchScore` *(overridden)*

Defined in actor.t, line 3701
