...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9967)


**Superclass chain:** [RecordOffAction](recordoffaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(RecordOff)**
...
Defined in en_us.t, line 9970


## Inherited Properties


*From [RecordOffAction](recordoffaction.md):* [`includeInUndo`](recordoffaction.md#includeInUndo)
...
*From [RecordOffAction](recordoffaction.md):* [`execSystemAction`](recordoffaction.md#execSystemAction), [`turnOffRecording`](recordoffaction.md#turnOffRecording)
