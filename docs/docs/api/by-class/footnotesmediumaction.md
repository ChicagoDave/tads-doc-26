...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1617)


**Superclass chain:** [FootnotesAction](footnotesaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FootnotesMediumActionSubclasses:** [predicate(FootnotesMedium)](predicate%28footnotesmedium%29.md)


## Properties


### `showFootnotes` *(overridden)*

Defined in actions.t, line 1618
