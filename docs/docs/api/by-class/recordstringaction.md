...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1448)


subclass of Record action taking a quoted string for the filename


**Superclass chain:** [RecordAction](recordaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RecordStringActionSubclasses:** [predicate(RecordString)](predicate%28recordstring%29.md), [RecordEventsStringAction](recordeventsstringaction.md), [predicate(RecordEventsString)](predicate%28recordeventsstring%29.md)


## Inherited Properties


*From [RecordAction](recordaction.md):* [`fileDisposition`](recordaction.md#fileDisposition), [`filePromptMsg`](recordaction.md#filePromptMsg), [`fileTypeID`](recordaction.md#fileTypeID), [`logFileType`](recordaction.md#logFileType)
...
Defined in actions.t, line 1449
