...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9913)


**Superclass chain:** [CreditsAction](creditsaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Credits)**
...
Defined in en_us.t, line 9916


## Inherited Properties


*From [CreditsAction](creditsaction.md):* [`includeInUndo`](creditsaction.md#includeInUndo)
...
*From [CreditsAction](creditsaction.md):* [`execSystemAction`](creditsaction.md#execSystemAction)
