...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10403)


**Superclass chain:** [PourIntoAction](pourintoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PourInto)**
...
Defined in en_us.t, line 10407


### `verbPhrase`

Defined in en_us.t, line 10406
