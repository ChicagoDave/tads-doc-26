...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10092)


**Superclass chain:** [JumpOffAction](jumpoffaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(JumpOff)**
...
Defined in en_us.t, line 10096


### `verbPhrase`

Defined in en_us.t, line 10095
