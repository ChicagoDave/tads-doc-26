...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3152)


invoke hint system


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **HintActionSubclasses:** [predicate(Hint)](predicate%28hint%29.md)
...
Defined in actions.t, line 3153
