...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10615)


**Superclass chain:** [GetOffOfAction](getoffofaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(GetOffOf)**
...
Defined in en_us.t, line 10619


### `verbPhrase`

Defined in en_us.t, line 10618
...
*From [GetOffOfAction](getoffofaction.md):* [`getAllDobj`](getoffofaction.md#getAllDobj)
