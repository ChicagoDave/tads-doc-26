...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9671)


**Superclass chain:** [ThrowToAction](throwtoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ThrowToType2)**
...
Defined in en_us.t, line 9675


### `isPrepositionalPhrasing` *(overridden)*

Defined in en_us.t, line 9678
