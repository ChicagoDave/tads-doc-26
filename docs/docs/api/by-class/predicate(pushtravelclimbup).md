...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10773)


**Superclass chain:** [PushTravelClimbUpAction](pushtravelclimbupaction.md) > [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **predicate(PushTravelClimbUp)**
...
*From [PushTravelClimbUpAction](pushtravelclimbupaction.md):* [`performTravel`](pushtravelclimbupaction.md#performTravel)
