...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9369)


**Superclass chain:** [PutInAction](putinaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PutIn)**
...
Defined in en_us.t, line 9374


### `verbPhrase`

Defined in en_us.t, line 9373
