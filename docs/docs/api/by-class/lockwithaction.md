...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2508)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **LockWithActionSubclasses:** [predicate(LockWith)](predicate%28lockwith%29.md)


## Properties


### `resolveFirst` *(overridden)*

Defined in actions.t, line 2515

Resolve the direct object (the lock) first, so that we know what we're trying to unlock when we're verifying the key. This allows us to (optionally) boost the likelihood of a known good key for disambiguation.


## Inherited Properties


*From [TIAction](tiaction.md):* [`actionIobjProp`](tiaction.md#actionIobjProp), [`askIobjResponseProd`](tiaction.md#askIobjResponseProd), [`checkIobjProp`](tiaction.md#checkIobjProp), [`execFirst`](tiaction.md#execFirst), [`iobjCur_`](tiaction.md#iobjCur_), [`iobjInfoCur_`](tiaction.md#iobjInfoCur_), [`iobjList_`](tiaction.md#iobjList_), [`iobjMatch`](tiaction.md#iobjMatch), [`iobjResolver_`](tiaction.md#iobjResolver_), [`isPrepositionalPhrasing`](tiaction.md#isPrepositionalPhrasing), [`lastObjList_`](tiaction.md#lastObjList_), [`needAnaphoricBinding_`](tiaction.md#needAnaphoricBinding_), [`omitIobjInDobjQuery`](tiaction.md#omitIobjInDobjQuery), [`preCondIobjProp`](tiaction.md#preCondIobjProp), [`predicateNounPhrases`](tiaction.md#predicateNounPhrases), [`remapIobjProp`](tiaction.md#remapIobjProp), [`resolveFirstEmpty`](tiaction.md#resolveFirstEmpty), [`tentativeDobj_`](tiaction.md#tentativeDobj_), [`tentativeIobj_`](tiaction.md#tentativeIobj_), [`verIobjProp`](tiaction.md#verIobjProp)
...
### `getAllIobj(actor, scopeList)` *(overridden)*

Defined in actions.t, line 2518
