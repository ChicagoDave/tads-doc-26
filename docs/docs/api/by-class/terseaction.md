...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 934)


Change to TERSE mode.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **TerseActionSubclasses:** [predicate(Terse)](predicate%28terse%29.md)
