...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4962)


contents lister for explicitly looking under an Underside


**Superclass chain:** [LookWhereContentsLister](lookwherecontentslister.md) > [DescContentsLister](desccontentslister.md) > [Lister](lister.md) > `object` > [BaseUndersideContentsLister](baseundersidecontentslister.md) > [BaseContentsLister](basecontentslister.md) > **undersideLookUnderLister**
