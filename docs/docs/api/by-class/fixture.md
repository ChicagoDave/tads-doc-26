...
Defined in objects.t, line 1852


### `cannotPutMsg`

Defined in objects.t, line 1853


### `cannotTakeMsg`

Defined in objects.t, line 1851

The messages to use for illogical messages. These can be overridden with new properties (of playerActionMessages and the like), or simply with single-quoted strings to display.
...
### `dobjFor(Move)` *(overridden)*

Defined in objects.t, line 1839


### `dobjFor(MoveTo)` *(overridden)*

Defined in objects.t, line 1841


### `dobjFor(MoveWith)` *(overridden)*

Defined in objects.t, line 1840


### `dobjFor(Pull)` *(overridden)*

Defined in objects.t, line 1838


### `dobjFor(Push)` *(overridden)*

Defined in objects.t, line 1837

fixed objects can't be pushed, pulled, or moved


### `dobjFor(PushTravel)` *(overridden)*

Defined in objects.t, line 1842


### `dobjFor(PutBehind)` *(overridden)*

Defined in objects.t, line 1834


### `dobjFor(PutIn)` *(overridden)*

Defined in objects.t, line 1831
...
Defined in objects.t, line 1832


### `dobjFor(PutUnder)` *(overridden)*

Defined in objects.t, line 1833


### `dobjFor(Take)` *(overridden)*

Defined in objects.t, line 1827

a fixed item can't be taken - this would be caught by verifyMoveTo anyway, but provide a more explicit message when a fixed item is explicitly taken


### `dobjFor(TakeFrom)` *(overridden)*

Defined in objects.t, line 1828


### `dobjFor(ThrowAt)` *(overridden)*

Defined in objects.t, line 1843


### `dobjFor(ThrowDir)` *(overridden)*

Defined in objects.t, line 1844


### `hideFromAll(action)` *(overridden)*

Defined in objects.t, line 1804

Hide fixtures from "all" for certain commands. Fixtures are obviously part of the location, so a reaonable person wouldn't even consider trying to do things like take them or move them.


### `hideFromDefault(action)` *(overridden)*

Defined in objects.t, line 1813
...
Defined in objects.t, line 1859

A component can be said to be owned by its location's owner or by its location.


### `verifyMoveTo(newLoc)` *(overridden)*

Defined in objects.t, line 1816
