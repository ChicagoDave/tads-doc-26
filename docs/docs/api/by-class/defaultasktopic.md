...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3691)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultAskTopic**
...
Defined in actor.t, line 3692


### `matchScore` *(overridden)*

Defined in actor.t, line 3693
