...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10751)


**Superclass chain:** [PushTravelThroughAction](pushtravelthroughaction.md) > [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **predicate(PushTravelThrough)**
...
*From [PushTravelThroughAction](pushtravelthroughaction.md):* [`performTravel`](pushtravelthroughaction.md#performTravel)
