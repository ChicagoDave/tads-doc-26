...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3711)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultGiveShowTopic**
...
Defined in actor.t, line 3712


### `matchScore` *(overridden)*

Defined in actor.t, line 3713
