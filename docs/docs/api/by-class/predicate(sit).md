...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10562)


**Superclass chain:** [SitAction](sitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Sit)**
...
*From [SitAction](sitaction.md):* [`execAction`](sitaction.md#execAction)
