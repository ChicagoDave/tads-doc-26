...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 7022)


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **adjPhrase(adjAdj)**
...
Defined in en_us.t, line 7035

return the list of objects in scope matching our adjective plus the list from the underlying adjective phrase


### `getVocabMatchList(resolver, results, extraFlags)` *(overridden)*

Defined in en_us.t, line 7025
