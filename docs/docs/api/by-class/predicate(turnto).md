...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10155)


**Superclass chain:** [TurnToAction](turntoaction.md) > [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(TurnTo)**
...
Defined in en_us.t, line 10160


### `omitIobjInDobjQuery`

Defined in en_us.t, line 10161


### `verbPhrase`

Defined in en_us.t, line 10159
