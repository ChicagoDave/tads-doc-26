...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1443)


subclass of Record action that sets up an event script recording


**Superclass chain:** [RecordAction](recordaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RecordEventsActionSubclasses:** [predicate(RecordEvents)](predicate%28recordevents%29.md)
...
Defined in actions.t, line 1444
