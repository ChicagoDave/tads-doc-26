...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5721)
...
**Superclass chain:** [LayeredNounPhraseProd](layerednounphraseprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **qualifiedNounPhrase(main)**
