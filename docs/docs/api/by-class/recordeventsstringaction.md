...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1457)


subclass of RecordString action that sets up an event script recording


**Superclass chain:** [RecordStringAction](recordstringaction.md) > [RecordAction](recordaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RecordEventsStringActionSubclasses:** [predicate(RecordEventsString)](predicate%28recordeventsstring%29.md)


## Properties


### `logFileType` *(overridden)*

Defined in actions.t, line 1458
