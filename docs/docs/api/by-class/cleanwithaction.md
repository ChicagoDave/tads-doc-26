...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2553)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **CleanWithActionSubclasses:** [predicate(CleanWith)](predicate%28cleanwith%29.md)
...
Defined in actions.t, line 2555
