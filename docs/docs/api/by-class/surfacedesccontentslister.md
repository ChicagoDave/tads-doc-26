...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4907)


Contents lister for a surface, used in a long description.


**Superclass chain:** [DescContentsLister](desccontentslister.md) > [Lister](lister.md) > `object` > [BaseSurfaceContentsLister](basesurfacecontentslister.md) > [BaseContentsLister](basecontentslister.md) > **surfaceDescContentsLister**
