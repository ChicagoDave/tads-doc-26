...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6409)


In the worst case, a simple noun phrase can be constructed from arbitrary words that don't appear in our dictionary.


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simpleNounPhrase(misc)**
