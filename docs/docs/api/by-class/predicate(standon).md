...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10584)


**Superclass chain:** [StandOnAction](standonaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(StandOn)**
...
Defined in en_us.t, line 10590


### `verbPhrase`

Defined in en_us.t, line 10589
