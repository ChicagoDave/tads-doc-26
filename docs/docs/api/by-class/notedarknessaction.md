...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 36)
...
**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **NoteDarknessAction**
