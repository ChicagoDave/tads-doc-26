...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1621)


**Superclass chain:** [FootnotesAction](footnotesaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FootnotesOffActionSubclasses:** [predicate(FootnotesOff)](predicate%28footnotesoff%29.md)
...
Defined in actions.t, line 1622
