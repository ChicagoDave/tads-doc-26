...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9307)


**Superclass chain:** [LookUnderAction](lookunderaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(LookUnder)**
