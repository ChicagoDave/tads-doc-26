...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1675)


run the inventory action


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **WaitActionSubclasses:** [predicate(Wait)](predicate%28wait%29.md)
...
Defined in actions.t, line 1676
