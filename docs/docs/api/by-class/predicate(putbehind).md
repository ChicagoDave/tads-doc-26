...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9392)


**Superclass chain:** [PutBehindAction](putbehindaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PutBehind)**
