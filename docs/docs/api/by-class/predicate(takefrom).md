...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9255)


**Superclass chain:** [TakeFromAction](takefromaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(TakeFrom)**
...
Defined in en_us.t, line 9260


## Inherited Properties


*From [TakeFromAction](takefromaction.md):* [`actionAllowsAll`](takefromaction.md#actionAllowsAll)
...
*From [TakeFromAction](takefromaction.md):* [`getAllDobj`](takefromaction.md#getAllDobj)
