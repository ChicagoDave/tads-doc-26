...
*class* — defined in [parser.t](../by-file/parser.t.md) (line 2750)


**Superclass chain:** [PossessivePronounNounProd](possessivepronounnounprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **YoursNounProdSubclasses:** [possessiveNounPhrase(yours)](possessivenounphrase%28yours%29.md)
