...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9269)


**Superclass chain:** [DropAction](dropaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Drop)**
...
Defined in en_us.t, line 9273


## Inherited Properties


*From [DropAction](dropaction.md):* [`actionAllowsAll`](dropaction.md#actionAllowsAll)
...
*From [DropAction](dropaction.md):* [`getAllDobj`](dropaction.md#getAllDobj)
