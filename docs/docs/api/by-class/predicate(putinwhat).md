...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9398)


**Superclass chain:** [PutInAction](putinaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PutInWhat)**
...
Defined in en_us.t, line 9401


## Inherited Properties


*From [PutInAction](putinaction.md):* [`actionAllowsAll`](putinaction.md#actionAllowsAll)


*From [TIAction](tiaction.md):* [`actionIobjProp`](tiaction.md#actionIobjProp), [`askIobjResponseProd`](tiaction.md#askIobjResponseProd), [`checkIobjProp`](tiaction.md#checkIobjProp), [`execFirst`](tiaction.md#execFirst), [`iobjCur_`](tiaction.md#iobjCur_), [`iobjInfoCur_`](tiaction.md#iobjInfoCur_), [`iobjList_`](tiaction.md#iobjList_), [`iobjMatch`](tiaction.md#iobjMatch), [`iobjResolver_`](tiaction.md#iobjResolver_), [`isPrepositionalPhrasing`](tiaction.md#isPrepositionalPhrasing), [`lastObjList_`](tiaction.md#lastObjList_), [`needAnaphoricBinding_`](tiaction.md#needAnaphoricBinding_), [`omitIobjInDobjQuery`](tiaction.md#omitIobjInDobjQuery), [`preCondIobjProp`](tiaction.md#preCondIobjProp), [`predicateNounPhrases`](tiaction.md#predicateNounPhrases), [`remapIobjProp`](tiaction.md#remapIobjProp), [`resolveFirst`](tiaction.md#resolveFirst), [`resolveFirstEmpty`](tiaction.md#resolveFirstEmpty), [`tentativeDobj_`](tiaction.md#tentativeDobj_), [`tentativeIobj_`](tiaction.md#tentativeIobj_), [`verIobjProp`](tiaction.md#verIobjProp)


*From [TAction](taction.md):* [`actionDobjProp`](taction.md#actionDobjProp), [`actor_`](taction.md#actor_), [`askDobjResponseProd`](taction.md#askDobjResponseProd), [`checkDobjProp`](taction.md#checkDobjProp), [`dobjCur_`](taction.md#dobjCur_), [`dobjInfoCur_`](taction.md#dobjInfoCur_), [`dobjList_`](taction.md#dobjList_), [`dobjMatch`](taction.md#dobjMatch), [`dobjResolver_`](taction.md#dobjResolver_), [`issuer_`](taction.md#issuer_), [`preCondDobjProp`](taction.md#preCondDobjProp), [`remapDobjProp`](taction.md#remapDobjProp), [`verDobjProp`](taction.md#verDobjProp), [`whichMessageObject`](taction.md#whichMessageObject)
