...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5415)
...
**Superclass chain:** [EmptyNounPhraseProd](emptynounphraseprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **singleNoun(empty)**


## Properties


### `fallbackResponseProd` *(overridden)*

Defined in en_us.t, line 5420
...
*From [EmptyNounPhraseProd](emptynounphraseprod.md):* [`asker_`](emptynounphraseprod.md#asker_), [`newMatch`](emptynounphraseprod.md#newMatch)
