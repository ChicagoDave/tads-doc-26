...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10058)


**Superclass chain:** [GoBackAction](gobackaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(GoBack)**
...
*From [GoBackAction](gobackaction.md):* [`execAction`](gobackaction.md#execAction)
