...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10794)


**Superclass chain:** [ExitsModeAction](exitsmodeaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(ExitsMode)**
...
*From [ExitsModeAction](exitsmodeaction.md):* [`execSystemAction`](exitsmodeaction.md#execSystemAction)
