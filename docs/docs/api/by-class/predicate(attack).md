...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9704)


**Superclass chain:** [AttackAction](attackaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Attack)**
...
Defined in en_us.t, line 9708


### `verbPhrase`

Defined in en_us.t, line 9707
