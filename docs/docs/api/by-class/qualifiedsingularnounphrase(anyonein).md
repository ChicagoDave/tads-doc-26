...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5798)


A singular object specified only by its containment, with an indefinite article.


**Superclass chain:** [VagueContainerIndefiniteNounPhraseProd](vaguecontainerindefinitenounphraseprod.md) > [VagueContainerNounPhraseProd](vaguecontainernounphraseprod.md) > [DefiniteNounProd](definitenounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > [AmbigResponseKeeper](ambigresponsekeeper.md) > **qualifiedSingularNounPhrase(anyOneIn)**
...
*From [VagueContainerIndefiniteNounPhraseProd](vaguecontainerindefinitenounphraseprod.md):* [`checkContentsList`](vaguecontainerindefinitenounphraseprod.md#checkContentsList)
