...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10811)


**Superclass chain:** [HintAction](hintaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Hint)**
...
*From [HintAction](hintaction.md):* [`execSystemAction`](hintaction.md#execSystemAction)
