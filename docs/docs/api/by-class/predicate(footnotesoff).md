...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9781)


**Superclass chain:** [FootnotesOffAction](footnotesoffaction.md) > [FootnotesAction](footnotesaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(FootnotesOff)**
...
Defined in en_us.t, line 9784


## Inherited Properties


*From [FootnotesOffAction](footnotesoffaction.md):* [`showFootnotes`](footnotesoffaction.md#showFootnotes)
