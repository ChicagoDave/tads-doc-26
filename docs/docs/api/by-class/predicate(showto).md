...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9622)


set up the empty indirect object phrase


**Superclass chain:** [ShowToAction](showtoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ShowTo)**
...
Defined in en_us.t, line 9626


### `verbPhrase`

Defined in en_us.t, line 9625
