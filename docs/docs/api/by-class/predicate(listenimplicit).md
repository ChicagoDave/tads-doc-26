...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9363)


**Superclass chain:** [ListenImplicitAction](listenimplicitaction.md) > [SenseImplicitAction](senseimplicitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(ListenImplicit)**
...
Defined in en_us.t, line 9366


## Inherited Properties


*From [ListenImplicitAction](listenimplicitaction.md):* [`defaultMsgProp`](listenimplicitaction.md#defaultMsgProp), [`descProp`](listenimplicitaction.md#descProp), [`mySense`](listenimplicitaction.md#mySense), [`resultLister`](listenimplicitaction.md#resultLister)
...
*From [SenseImplicitAction](senseimplicitaction.md):* [`execAction`](senseimplicitaction.md#execAction)
