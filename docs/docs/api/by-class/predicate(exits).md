...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10788)


**Superclass chain:** [ExitsAction](exitsaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Exits)**
...
*From [ExitsAction](exitsaction.md):* [`execAction`](exitsaction.md#execAction)
