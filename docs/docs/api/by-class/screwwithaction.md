...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2660)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **ScrewWithActionSubclasses:** [predicate(ScrewWith)](predicate%28screwwith%29.md)
...
Defined in actions.t, line 2662
