...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2395)


**Superclass chain:** [TopicTAction](topictaction.md) > [TopicActionBase](topicactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **ConsultAboutActionSubclasses:** [predicate(ConsultAbout)](predicate%28consultabout%29.md), [predicate(ConsultWhatAbout)](predicate%28consultwhatabout%29.md)
...
### `filterTopic(lst, np, resolver)` *(overridden)*

Defined in actions.t, line 2414

Filter the topic phrase resolution. If we know our direct object, and it's a Consultable, refer the resolution to the Consultable.


### `getDefaultDobj(np, resolver)` *(overridden)*

Defined in actions.t, line 2396
