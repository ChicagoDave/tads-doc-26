...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1683)


just show the "time passes" message


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **LookActionSubclasses:** [predicate(Look)](predicate%28look%29.md)
...
Defined in actions.t, line 1684
