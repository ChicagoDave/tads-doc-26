...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2804)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **EastAction**
...
Defined in actions.t, line 2805
