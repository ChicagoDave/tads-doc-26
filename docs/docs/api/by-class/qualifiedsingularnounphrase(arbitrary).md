...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5754)


A singular qualified noun phrase with an explicit arbitrary determiner.


**Superclass chain:** [ArbitraryNounProd](arbitrarynounprod.md) > [IndefiniteNounProd](indefinitenounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **qualifiedSingularNounPhrase(arbitrary)**
