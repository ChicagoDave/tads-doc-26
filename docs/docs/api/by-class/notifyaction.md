...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1016)


Show the NOTIFY status.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **NotifyActionSubclasses:** [predicate(Notify)](predicate%28notify%29.md)
...
Defined in actions.t, line 1017
