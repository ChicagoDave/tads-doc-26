...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9811)


**Superclass chain:** [VerboseAction](verboseaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Verbose)**
...
*From [VerboseAction](verboseaction.md):* [`execSystemAction`](verboseaction.md#execSystemAction)
