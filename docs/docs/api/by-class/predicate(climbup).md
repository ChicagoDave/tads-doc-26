...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10424)


**Superclass chain:** [ClimbUpAction](climbupaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ClimbUp)**
...
Defined in en_us.t, line 10428


### `verbPhrase`

Defined in en_us.t, line 10427
