...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1691)


show the actor's current location in verbose mode


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **SleepActionSubclasses:** [predicate(Sleep)](predicate%28sleep%29.md)
...
Defined in actions.t, line 1692
