...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2386)


**Superclass chain:** [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **TypeLiteralOnActionSubclasses:** [predicate(TypeLiteralOn)](predicate%28typeliteralon%29.md), [predicate(TypeLiteralOnWhat)](predicate%28typeliteralonwhat%29.md)
