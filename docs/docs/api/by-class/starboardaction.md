...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2843)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **StarboardActionSubclasses:** [predicate(Starboard)](predicate%28starboard%29.md)
...
Defined in actions.t, line 2844
