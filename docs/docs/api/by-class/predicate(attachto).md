...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10476)


**Superclass chain:** [AttachToAction](attachtoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(AttachTo)**
...
Defined in en_us.t, line 10479


### `verbPhrase`

Defined in en_us.t, line 10480
