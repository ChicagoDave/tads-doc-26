...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9990)


**Superclass chain:** [VagueTravelAction](vaguetravelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(VagueTravel)**
...
*From [VagueTravelAction](vaguetravelaction.md):* [`execAction`](vaguetravelaction.md#execAction)
