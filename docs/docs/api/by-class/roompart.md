...
*class* — defined in [travel.t](../by-file/travel.t.md) (line 4872)


Room Part - base class for "parts" of rooms, such as floors and walls. Room parts are unusual in a couple of ways.


**Superclass chain:** [Fixture](fixture.md) > [NonPortable](nonportable.md) > [Thing](thing.md) > [VocabObject](vocabobject.md) > `object` > **RoomPartSubclasses:** [DefaultWall](defaultwall.md), [Floor](floor.md)


**Global objects:** [defaultCeiling](defaultceiling.md), [defaultSky](defaultsky.md)
...
Defined in travel.t, line 5108


### `lookInLister` *(overridden)*

Defined in travel.t, line 5109


### `nothingBehindMsg`

Defined in travel.t, line 5128


### `nothingThroughMsg`

Defined in travel.t, line 5129


### `nothingUnderMsg`

Defined in travel.t, line 5127

we can't look behind/through/under a room part by default


### `sightSize` *(overridden)*

Defined in travel.t, line 4973
...
### `specialContentsLister` *(overridden)*

Defined in travel.t, line 5110
