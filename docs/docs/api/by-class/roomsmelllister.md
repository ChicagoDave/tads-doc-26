...
*object* — defined in [lister.t](../by-file/lister.t.md) (line 1820)


Room contents lister for things that can be smelled.


**Superclass chain:** [SenseLister](senselister.md) > [ParagraphLister](paragraphlister.md) > [Lister](lister.md) > `object` > **roomSmellLister**
