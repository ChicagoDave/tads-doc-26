...
*class* — defined in [action.t](../by-file/action.t.md) (line 6107)


A conversational intransitive action. This class is for actions such as Hello, Goodbye, Yes, No - conversational actions that don't involve any topics or other objects, but whose expression is entirely contained in the verb.


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ConvIActionSubclasses:** [GoodbyeAction](goodbyeaction.md), [predicate(Goodbye)](predicate%28goodbye%29.md), [HelloAction](helloaction.md), [predicate(Hello)](predicate%28hello%29.md), [NoAction](noaction.md), [predicate(No)](predicate%28no%29.md), [YesAction](yesaction.md), [predicate(Yes)](predicate%28yes%29.md)
...
### `isConversational(issuer)` *(overridden)*

Defined in action.t, line 6109
