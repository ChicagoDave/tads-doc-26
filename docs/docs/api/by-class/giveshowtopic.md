...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3103)


A GIVE/SHOW topic database entry.


**Superclass chain:** [ThingMatchTopic](thingmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **GiveShowTopicSubclasses:** [GiveTopic](givetopic.md), [ShowTopic](showtopic.md)
