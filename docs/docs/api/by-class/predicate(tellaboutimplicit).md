...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9497)


**Superclass chain:** [TellAboutAction](tellaboutaction.md) > [ConvTopicTAction](convtopictaction.md) > [TopicTAction](topictaction.md) > [TopicActionBase](topicactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(TellAboutImplicit)**
...
Defined in en_us.t, line 9501


### `verbPhrase`

Defined in en_us.t, line 9500
