...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1613)


**Superclass chain:** [FootnotesAction](footnotesaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FootnotesFullActionSubclasses:** [predicate(FootnotesFull)](predicate%28footnotesfull%29.md)
...
Defined in actions.t, line 1614
