...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1753)


now generate the subset of in-scope objects that are directly in any of these locations (or directly in items fixed in place within any of these locations), and return the result


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **TakeFromActionSubclasses:** [predicate(TakeFrom)](predicate%28takefrom%29.md)
...
Defined in actions.t, line 1755
...
Defined in actions.t, line 1758
...
<details><summary>From [TAction](taction.md) (23)</summary>
