...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9763)


**Superclass chain:** [FootnoteAction](footnoteaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Footnote)**
...
Defined in en_us.t, line 9766


## Inherited Properties


*From [FootnoteAction](footnoteaction.md):* [`includeInUndo`](footnoteaction.md#includeInUndo)
...
*From [FootnoteAction](footnoteaction.md):* [`execSystemAction`](footnoteaction.md#execSystemAction)
