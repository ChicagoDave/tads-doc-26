...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 564)
...
**Superclass chain:** [RestoreAction](restoreaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RestoreStringActionSubclasses:** [predicate(RestoreString)](predicate%28restorestring%29.md)
