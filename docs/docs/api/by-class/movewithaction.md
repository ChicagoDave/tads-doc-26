...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2352)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **MoveWithActionSubclasses:** [predicate(MoveWith)](predicate%28movewith%29.md)
...
Defined in actions.t, line 2354
