...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6255)


just a numeric/string adjective (for things like "push 3", "push #3", 'push "G"')


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simpleNounPhrase(number)**
