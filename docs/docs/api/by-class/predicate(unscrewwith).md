...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10737)


**Superclass chain:** [UnscrewWithAction](unscrewwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(UnscrewWith)**
...
Defined in en_us.t, line 10742


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10741


### `verbPhrase`

Defined in en_us.t, line 10740
...
*From [UnscrewWithAction](unscrewwithaction.md):* [`getAllIobj`](unscrewwithaction.md#getAllIobj)
