...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1328)
...
**Superclass chain:** [ScriptAction](scriptaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ScriptStringActionSubclasses:** [predicate(ScriptString)](predicate%28scriptstring%29.md)
...
Defined in actions.t, line 1329
