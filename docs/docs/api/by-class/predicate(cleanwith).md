...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10468)


**Superclass chain:** [CleanWithAction](cleanwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(CleanWith)**
...
Defined in en_us.t, line 10472


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10473


### `verbPhrase`

Defined in en_us.t, line 10471
...
*From [CleanWithAction](cleanwithaction.md):* [`getAllIobj`](cleanwithaction.md#getAllIobj)
