...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10579)


**Superclass chain:** [LieAction](lieaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Lie)**
...
*From [LieAction](lieaction.md):* [`execAction`](lieaction.md#execAction)
