...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9711)


**Superclass chain:** [AttackWithAction](attackwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(AttackWith)**
...
Defined in en_us.t, line 9717


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 9718


### `verbPhrase`

Defined in en_us.t, line 9716
...
*From [AttackWithAction](attackwithaction.md):* [`getAllIobj`](attackwithaction.md#getAllIobj)
