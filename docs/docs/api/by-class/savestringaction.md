...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 318)
...
**Superclass chain:** [SaveAction](saveaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **SaveStringActionSubclasses:** [predicate(SaveString)](predicate%28savestring%29.md)
