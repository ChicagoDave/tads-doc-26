...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1640)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **InventoryActionSubclasses:** [predicate(Inventory)](predicate%28inventory%29.md)
...
Defined in actions.t, line 1648
...
Defined in actions.t, line 1641
