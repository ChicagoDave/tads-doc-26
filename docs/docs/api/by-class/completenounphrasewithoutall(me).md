...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5652)


First-person pronoun, for referring to the speaker: "bob, look at me"


**Superclass chain:** [MeProd](meprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **completeNounPhraseWithoutAll(me)**


## Inherited Properties


*From [MeProd](meprod.md):* [`pronounType`](meprod.md#pronounType)
