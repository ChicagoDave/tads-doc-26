...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2285)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **AttackWithActionSubclasses:** [predicate(AttackWith)](predicate%28attackwith%29.md)
...
Defined in actions.t, line 2290

for the indirect object, limit 'all' and defaults to the items in inventory
