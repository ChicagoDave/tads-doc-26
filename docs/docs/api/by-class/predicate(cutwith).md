...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10377)


set up the empty indirect object phrase


**Superclass chain:** [CutWithAction](cutwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(CutWith)**
...
Defined in en_us.t, line 10381


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10382


### `verbPhrase`

Defined in en_us.t, line 10380
