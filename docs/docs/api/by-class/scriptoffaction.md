...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1349)


Turn scripting off. This stops recording the game transcript started with the most recent SCRIPT command.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ScriptOffActionSubclasses:** [predicate(ScriptOff)](predicate%28scriptoff%29.md)
...
Defined in actions.t, line 1378
...
Defined in actions.t, line 1350


### `turnOffScripting(ack)`

Defined in actions.t, line 1357
