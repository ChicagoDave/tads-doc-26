...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 5057)


in-line contents lister for a RearContainer/Surface


**Superclass chain:** [BaseInlineContentsLister](baseinlinecontentslister.md) > [ContentsLister](contentslister.md) > [Lister](lister.md) > `object` > **rearInlineContentsLister**
