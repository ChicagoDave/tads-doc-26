...
*class* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4989)


Base class for contents listers for an RearContainer or RearSurface


**Superclass chain:** [BaseContentsLister](basecontentslister.md) > [Lister](lister.md) > `object` > **BaseRearContentsListerGlobal objects:** [rearContentsLister](rearcontentslister.md), [rearDescContentsLister](reardesccontentslister.md), [rearLookBehindLister](rearlookbehindlister.md)
