...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10597)


**Superclass chain:** [StandAction](standaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Stand)**
...
*From [StandAction](standaction.md):* [`execAction`](standaction.md#execAction)
