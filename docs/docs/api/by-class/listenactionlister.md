...
*object* — defined in [lister.t](../by-file/lister.t.md) (line 1805)


Lister for explicit "listen" action


**Superclass chain:** [roomListenLister](roomlistenlister.md) > [SenseLister](senselister.md) > [ParagraphLister](paragraphlister.md) > [Lister](lister.md) > `object` > **listenActionLister**
...
*From [roomListenLister](roomlistenlister.md):* [`showListItem`](roomlistenlister.md#showListItem)


*From [SenseLister](senselister.md):* [`showListItemCounted`](senselister.md#showListItemCounted)
