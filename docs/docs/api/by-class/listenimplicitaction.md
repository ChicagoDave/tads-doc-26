...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1871)


**Superclass chain:** [SenseImplicitAction](senseimplicitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ListenImplicitActionSubclasses:** [predicate(ListenImplicit)](predicate%28listenimplicit%29.md)


## Properties


### `defaultMsgProp` *(overridden)*

Defined in actions.t, line 1874


### `descProp` *(overridden)*

Defined in actions.t, line 1873


### `mySense` *(overridden)*

Defined in actions.t, line 1872


### `resultLister` *(overridden)*

Defined in actions.t, line 1875
