...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10013)


**Superclass chain:** [PortAction](portaction.md) > [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Port)**
...
Defined in en_us.t, line 10017


## Inherited Properties


*From [PortAction](portaction.md):* [`getDirection`](portaction.md#getDirection)
