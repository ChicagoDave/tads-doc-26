...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9664)


**Superclass chain:** [ThrowToAction](throwtoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ThrowTo)**
...
Defined in en_us.t, line 9668


### `verbPhrase`

Defined in en_us.t, line 9667
