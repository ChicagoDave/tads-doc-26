...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10646)


**Superclass chain:** [SleepAction](sleepaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Sleep)**
...
*From [SleepAction](sleepaction.md):* [`execAction`](sleepaction.md#execAction)
