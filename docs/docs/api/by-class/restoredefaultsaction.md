...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 782)


Restore defaults


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RestoreDefaultsActionSubclasses:** [predicate(RestoreDefaults)](predicate%28restoredefaults%29.md)
