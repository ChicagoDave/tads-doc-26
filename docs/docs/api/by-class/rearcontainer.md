...
*class* — defined in [extras.t](../by-file/extras.t.md) (line 927)


A "rear container" is similar to an underside: it models the space behind an object.


**Superclass chain:** [SpaceOverlay](spaceoverlay.md) > [BulkLimiter](bulklimiter.md) > [Thing](thing.md) > [VocabObject](vocabobject.md) > `object` > **RearContainerSubclasses:** [RearSurface](rearsurface.md), [RestrictedRearSurface](restrictedrearsurface.md), [RestrictedRearContainer](restrictedrearcontainer.md)


## Properties


### `abandonContentsLister` *(overridden)*

Defined in extras.t, line 943


### `actorInPrep` *(overridden)*

Defined in en_us.t, line 2115


### `actorOutOfPrep` *(overridden)*

Defined in en_us.t, line 2116


### `allowPutBehind`

Defined in extras.t, line 933

Can actors put new objects behind self, using the PUT BEHIND command? By default, we allow it. Override this property to nil if new objects cannot be added by player commands.


### `alreadyPutInMsg`

Defined in extras.t, line 965


### `cannotPutInSelfMsg`

Defined in extras.t, line 964

customize the verification messages


### `circularlyInMessage` *(overridden)*

Defined in extras.t, line 952

my message indicating that another object x cannot be put into me because I'm already in x


### `contentsLister` *(overridden)*

Defined in extras.t, line 939

use custom contents listers


### `descContentsLister` *(overridden)*

Defined in extras.t, line 940


### `inlineContentsLister` *(overridden)*

Defined in extras.t, line 942


### `lookInLister` *(overridden)*

Defined in extras.t, line 941


### `objInPrep` *(overridden)*

Defined in en_us.t, line 2114


### `putDestMessage`

Defined in extras.t, line 955
...
Defined in extras.t, line 946

the message for taking things from me that aren't behind me


### `tooFullMsg` *(overridden)*

Defined in extras.t, line 958
...
Defined in extras.t, line 999

Looking "behind" a surface simply shows the surface's contents.


### `iobjFor(PutBehind)` *(overridden)*

Defined in extras.t, line 974
