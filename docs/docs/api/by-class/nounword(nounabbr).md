...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6648)


**Superclass chain:** [NounWordProd](nounwordprod.md) > [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **nounWord(nounAbbr)**
...
### `getNounText` *(overridden)*

Defined in en_us.t, line 6656

for dictionary matching purposes, include the text of our noun with the period attached - the period is part of the dictionary entry for an abbreviated word


## Inherited Methods


*From [NounWordProd](nounwordprod.md):* [`getAdjustedTokens`](nounwordprod.md#getAdjustedTokens), [`getVocabMatchList`](nounwordprod.md#getVocabMatchList)
