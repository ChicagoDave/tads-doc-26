...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10064)


**Superclass chain:** [DigAction](digaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Dig)**
...
Defined in en_us.t, line 10068


### `verbPhrase`

Defined in en_us.t, line 10067
