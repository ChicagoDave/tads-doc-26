...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9727)


**Superclass chain:** [InventoryTallAction](inventorytallaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(InventoryTall)**
...
*From [InventoryTallAction](inventorytallaction.md):* [`execAction`](inventorytallaction.md#execAction)
