...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6970)


A simple plural phrase can match unknown words as a last resort.


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simplePluralPhrase(misc)**
