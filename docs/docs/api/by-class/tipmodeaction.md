...
*class* — defined in [tips.t](../by-file/tips.t.md) (line 216)


Define a system action for turning tip mode on/off.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **TipModeActionSubclasses:** [predicate(TipsOff)](predicate%28tipsoff%29.md), [predicate(TipsOn)](predicate%28tipson%29.md)
