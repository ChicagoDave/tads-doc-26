...
*class* — defined in [travel.t](../by-file/travel.t.md) (line 6305)
...
**Superclass chain:** [NestedRoom](nestedroom.md) > [BasicLocation](basiclocation.md) > [Thing](thing.md) > [VocabObject](vocabobject.md) > `object` > **BasicChairSubclasses:** [BasicBed](basicbed.md), [BasicPlatform](basicplatform.md), [Booth](booth.md), [Platform](platform.md), [NominalPlatform](nominalplatform.md), [Bed](bed.md), [Chair](chair.md)
...
Defined in en_us.t, line 2892


### `actorOutOfPrep` *(overridden)*

Defined in en_us.t, line 2893


### `allowedPostures`

Defined in travel.t, line 6311
...
### `defaultPosture` *(overridden)*

Defined in travel.t, line 6357
...
### `mustMoveIntoProp` *(overridden)*

Defined in travel.t, line 6354
