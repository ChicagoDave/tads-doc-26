...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9751)


**Superclass chain:** [QuitAction](quitaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Quit)**
...
Defined in en_us.t, line 9754


## Inherited Properties


*From [QuitAction](quitaction.md):* [`includeInUndo`](quitaction.md#includeInUndo)
...
*From [QuitAction](quitaction.md):* [`execSystemAction`](quitaction.md#execSystemAction), [`terminateGame`](quitaction.md#terminateGame)
