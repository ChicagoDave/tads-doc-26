...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1031)


Turn score change notifications on.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **NotifyOnActionSubclasses:** [predicate(NotifyOn)](predicate%28notifyon%29.md)
...
Defined in actions.t, line 1032
