...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10027)


**Superclass chain:** [InAction](inaction.md) > [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(In)**
...
Defined in en_us.t, line 10031


## Inherited Properties


*From [InAction](inaction.md):* [`getDirection`](inaction.md#getDirection)
