...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2262)


check the actor for a current interlocutor


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **FollowActionSubclasses:** [predicate(Follow)](predicate%28follow%29.md)
