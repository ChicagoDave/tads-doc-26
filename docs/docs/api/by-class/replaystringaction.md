...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1545)


subclass of Replay action taking a quoted string for the filename


**Superclass chain:** [ReplayAction](replayaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ReplayStringActionSubclasses:** [predicate(ReplayQuiet)](predicate%28replayquiet%29.md), [predicate(ReplayString)](predicate%28replaystring%29.md)


## Inherited Properties


*From [ReplayAction](replayaction.md):* [`fileDisposition`](replayaction.md#fileDisposition), [`filePromptMsg`](replayaction.md#filePromptMsg), [`fileTypeID`](replayaction.md#fileTypeID), [`scriptOptionFlags`](replayaction.md#scriptOptionFlags)
...
Defined in actions.t, line 1546
