...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9536)


**Superclass chain:** [TalkToAction](talktoaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(TalkTo)**
...
Defined in en_us.t, line 9540


### `verbPhrase`

Defined in en_us.t, line 9539
