...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1500)


REPLAY - play back a command log previously recorded.


**Superclass chain:** [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ReplayActionSubclasses:** [ReplayStringAction](replaystringaction.md), [predicate(ReplayQuiet)](predicate%28replayquiet%29.md), [predicate(ReplayString)](predicate%28replaystring%29.md)
...
Defined in actions.t, line 1504


### `filePromptMsg` *(overridden)*

Defined in actions.t, line 1502
...
Defined in actions.t, line 1503


### `scriptOptionFlags`

Defined in actions.t, line 1510
...
Defined in actions.t, line 1513
...
Defined in actions.t, line 1507
