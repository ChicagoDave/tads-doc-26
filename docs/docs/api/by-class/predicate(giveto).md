...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9593)


**Superclass chain:** [GiveToAction](givetoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(GiveTo)**
...
Defined in en_us.t, line 9597


### `verbPhrase`

Defined in en_us.t, line 9596
