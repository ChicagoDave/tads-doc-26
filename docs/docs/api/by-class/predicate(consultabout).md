...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10264)


**Superclass chain:** [ConsultAboutAction](consultaboutaction.md) > [TopicTAction](topictaction.md) > [TopicActionBase](topicactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(ConsultAbout)**
...
Defined in en_us.t, line 10276


### `omitIobjInDobjQuery`

Defined in en_us.t, line 10275


### `verbPhrase`

Defined in en_us.t, line 10274
