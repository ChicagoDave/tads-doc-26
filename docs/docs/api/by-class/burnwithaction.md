...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2455)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **BurnWithActionSubclasses:** [predicate(BurnWith)](predicate%28burnwith%29.md)
...
Defined in actions.t, line 2463
...
Defined in actions.t, line 2457
