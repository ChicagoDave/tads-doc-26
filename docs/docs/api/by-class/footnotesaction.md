...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1590)


base class for FOOTNOTES xxx commands


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FootnotesActionSubclasses:** [FootnotesFullAction](footnotesfullaction.md), [predicate(FootnotesFull)](predicate%28footnotesfull%29.md), [FootnotesMediumAction](footnotesmediumaction.md), [predicate(FootnotesMedium)](predicate%28footnotesmedium%29.md), [FootnotesOffAction](footnotesoffaction.md), [predicate(FootnotesOff)](predicate%28footnotesoff%29.md)
...
Defined in actions.t, line 1610

the footnote status I set when this command is activated - this must be overridden by each subclass
...
Defined in actions.t, line 1591
