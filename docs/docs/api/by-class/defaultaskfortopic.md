...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3715)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultAskForTopic**
...
Defined in actor.t, line 3716


### `matchScore` *(overridden)*

Defined in actor.t, line 3717
