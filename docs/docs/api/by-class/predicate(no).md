...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9581)


**Superclass chain:** [NoAction](noaction.md) > [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(No)**
...
*From [NoAction](noaction.md):* [`execAction`](noaction.md#execAction)
