...
*class* — defined in [parser.t](../by-file/parser.t.md) (line 2742)


**Superclass chain:** [PossessivePronounNounProd](possessivepronounnounprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **HersNounProdSubclasses:** [possessiveNounPhrase(hers)](possessivenounphrase%28hers%29.md)
