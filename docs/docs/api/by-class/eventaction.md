...
*class* — defined in [events.t](../by-file/events.t.md) (line 570)


Pseudo-action subclass to represent the action environment while processing a daemon, fuse, or other event.


**Superclass chain:** [Action](action.md) > [BasicProd](basicprod.md) > `object` > **EventAction**
...
Defined in events.t, line 575

event actions are internal system actions; they don't consume additional turns themselves, since they run between player turns
