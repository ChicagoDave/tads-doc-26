...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9657)


**Superclass chain:** [ThrowAtAction](throwataction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ThrowAt)**
...
Defined in en_us.t, line 9661


### `verbPhrase`

Defined in en_us.t, line 9660
