...
*class* — defined in [report.t](../by-file/report.t.md) (line 226)


"before" report - these come before the main report


**Superclass chain:** [FullCommandReport](fullcommandreport.md) > [CommandReportMessage](commandreportmessage.md) > [CommandReport](commandreport.md) > `object` > [MessageResult](messageresult.md) > **BeforeCommandReport**
