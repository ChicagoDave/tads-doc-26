...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9865)


**Superclass chain:** [RestoreAction](restoreaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Restore)**
...
*From [RestoreAction](restoreaction.md):* [`askAndRestore`](restoreaction.md#askAndRestore), [`execSystemAction`](restoreaction.md#execSystemAction), [`performRestore`](restoreaction.md#performRestore), [`startupRestore`](restoreaction.md#startupRestore)
