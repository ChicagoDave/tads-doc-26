...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9919)


**Superclass chain:** [AboutAction](aboutaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(About)**
...
Defined in en_us.t, line 9922


## Inherited Properties


*From [AboutAction](aboutaction.md):* [`includeInUndo`](aboutaction.md#includeInUndo)
...
*From [AboutAction](aboutaction.md):* [`execSystemAction`](aboutaction.md#execSystemAction)
