...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9859)


**Superclass chain:** [SaveStringAction](savestringaction.md) > [SaveAction](saveaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(SaveString)**
...
Defined in en_us.t, line 9862


## Inherited Properties


*From [SaveAction](saveaction.md):* [`fileDisposition`](saveaction.md#fileDisposition), [`filePromptMsg`](saveaction.md#filePromptMsg), [`fileTypeID`](saveaction.md#fileTypeID), [`includeInUndo`](saveaction.md#includeInUndo), [`isRepeatable`](saveaction.md#isRepeatable)
...
*From [SaveStringAction](savestringaction.md):* [`execSystemAction`](savestringaction.md#execSystemAction)


*From [SaveAction](saveaction.md):* [`performFileOp`](saveaction.md#performFileOp), [`showCancelMsg`](saveaction.md#showCancelMsg)
