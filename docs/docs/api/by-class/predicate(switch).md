...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10297)


set up the empty direct object phrase


**Superclass chain:** [SwitchAction](switchaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Switch)**
