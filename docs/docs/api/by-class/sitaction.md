...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2561)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **SitActionSubclasses:** [predicate(Sit)](predicate%28sit%29.md)
...
Defined in actions.t, line 2562
