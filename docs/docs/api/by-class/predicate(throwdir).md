...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9681)


**Superclass chain:** [ThrowDirAction](throwdiraction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ThrowDir)**
...
*From [ThrowDirAction](throwdiraction.md):* [`getDirection`](throwdiraction.md#getDirection)
