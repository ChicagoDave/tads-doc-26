...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2003)


the issuing actor is saying goodbye to the target actor


**Superclass chain:** [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **YesActionSubclasses:** [predicate(Yes)](predicate%28yes%29.md)
...
Defined in actions.t, line 2004
