...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2779)
...
**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **TravelDirAction**
...
Defined in actions.t, line 2790
...
Defined in actions.t, line 2780


### `getDirection` *(overridden)*

Defined in actions.t, line 2787
...
*From [TravelAction](travelaction.md):* [`actionOfKind`](travelaction.md#actionOfKind), [`execAction`](travelaction.md#execAction), [`getConnector`](travelaction.md#getConnector)
