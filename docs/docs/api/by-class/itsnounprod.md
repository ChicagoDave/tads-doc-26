...
*class* — defined in [parser.t](../by-file/parser.t.md) (line 2734)


**Superclass chain:** [PossessivePronounNounProd](possessivepronounnounprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **ItsNounProdSubclasses:** [possessiveNounPhrase(its)](possessivenounphrase%28its%29.md)
