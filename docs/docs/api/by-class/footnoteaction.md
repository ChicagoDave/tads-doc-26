...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1573)


Footnote - this requires a numeric argument parsed via the numberPhrase production and assigned to the numMatch property.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FootnoteActionSubclasses:** [predicate(Footnote)](predicate%28footnote%29.md)
...
Defined in actions.t, line 1584
...
Defined in actions.t, line 1574
