...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2617)


'all' for 'get out of' is the actor's immediate container


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **GetOffOfActionSubclasses:** [predicate(GetOffOf)](predicate%28getoffof%29.md)
...
Defined in actions.t, line 2618
