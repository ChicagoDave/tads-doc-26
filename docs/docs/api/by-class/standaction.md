...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2598)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **StandActionSubclasses:** [predicate(Stand)](predicate%28stand%29.md)
...
Defined in actions.t, line 2599
