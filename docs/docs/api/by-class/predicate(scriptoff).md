...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9937)


**Superclass chain:** [ScriptOffAction](scriptoffaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(ScriptOff)**
...
Defined in en_us.t, line 9940


## Inherited Properties


*From [ScriptOffAction](scriptoffaction.md):* [`includeInUndo`](scriptoffaction.md#includeInUndo)
...
*From [ScriptOffAction](scriptoffaction.md):* [`execSystemAction`](scriptoffaction.md#execSystemAction), [`turnOffScripting`](scriptoffaction.md#turnOffScripting)
