...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10147)


**Superclass chain:** [TurnWithAction](turnwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(TurnWith)**
...
Defined in en_us.t, line 10151


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10152


### `verbPhrase`

Defined in en_us.t, line 10150
...
*From [TurnWithAction](turnwithaction.md):* [`getAllIobj`](turnwithaction.md#getAllIobj)
