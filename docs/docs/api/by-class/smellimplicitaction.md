...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1864)


there's nothing to show - say so


**Superclass chain:** [SenseImplicitAction](senseimplicitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **SmellImplicitActionSubclasses:** [predicate(SmellImplicit)](predicate%28smellimplicit%29.md)
...
Defined in actions.t, line 1867


### `descProp` *(overridden)*

Defined in actions.t, line 1866


### `mySense` *(overridden)*

Defined in actions.t, line 1865


### `resultLister` *(overridden)*

Defined in actions.t, line 1868
