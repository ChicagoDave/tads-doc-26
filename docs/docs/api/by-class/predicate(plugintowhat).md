...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10685)


**Superclass chain:** [PlugIntoAction](plugintoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PlugIntoWhat)**
