...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10567)


**Superclass chain:** [LieOnAction](lieonaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(LieOn)**
...
Defined in en_us.t, line 10572


### `verbPhrase`

Defined in en_us.t, line 10571
