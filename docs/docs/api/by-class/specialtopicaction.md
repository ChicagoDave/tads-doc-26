...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2033)
...
**Superclass chain:** [LiteralAction](literalaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > **SpecialTopicActionSubclasses:** [predicate(SpecialTopic)](predicate%28specialtopic%29.md)
...
Defined in actions.t, line 2099
...
Defined in actions.t, line 2092
...
Defined in actions.t, line 2034


### `getEnteredText`

Defined in actions.t, line 2085

Get the original player-entered text. This is our literal phrase, with the embedded-quote encoding decoded.


### `repeatAction(lastTargetActor, lastTargetActorPhrase, lastIssuingActor, countsAsIssuerTurn)` *(overridden)*

Defined in actions.t, line 2048
