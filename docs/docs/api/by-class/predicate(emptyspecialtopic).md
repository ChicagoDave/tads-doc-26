...
*grammar* — defined in [actions.t](../by-file/actions.t.md) (line 2118)


in case they try typing just 'xspcltopic'


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(EmptySpecialTopic)**
...
Defined in actions.t, line 2122
