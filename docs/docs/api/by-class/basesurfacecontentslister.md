...
*class* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4889)


Base class for contents listers for a surface


**Superclass chain:** [BaseContentsLister](basecontentslister.md) > [Lister](lister.md) > `object` > **BaseSurfaceContentsListerGlobal objects:** [surfaceContentsLister](surfacecontentslister.md), [surfaceDescContentsLister](surfacedesccontentslister.md), [surfaceLookInLister](surfacelookinlister.md)
...
*From [BaseContentsLister](basecontentslister.md):* [`showListContentsPrefixTall`](basecontentslister.md#showListContentsPrefixTall), [`showListPrefixTall`](basecontentslister.md#showListPrefixTall), [`showListPrefixWide`](basecontentslister.md#showListPrefixWide), [`showListSuffixWide`](basecontentslister.md#showListSuffixWide)
