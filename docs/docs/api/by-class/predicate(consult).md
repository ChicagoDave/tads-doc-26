...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10258)
...
**Superclass chain:** [ConsultAction](consultaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Consult)**
...
Defined in en_us.t, line 10261


### `verbPhrase`

Defined in en_us.t, line 10260
