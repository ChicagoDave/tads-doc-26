...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1651)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **InventoryTallActionSubclasses:** [predicate(InventoryTall)](predicate%28inventorytall%29.md)
...
Defined in actions.t, line 1652
