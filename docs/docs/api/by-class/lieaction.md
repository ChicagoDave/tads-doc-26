...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2578)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **LieActionSubclasses:** [predicate(Lie)](predicate%28lie%29.md)
...
Defined in actions.t, line 2579
