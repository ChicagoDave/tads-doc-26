...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10658)


**Superclass chain:** [FastenToAction](fastentoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(FastenTo)**
...
Defined in en_us.t, line 10662


### `verbPhrase`

Defined in en_us.t, line 10661
