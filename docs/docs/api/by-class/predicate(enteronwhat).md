...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10211)


**Superclass chain:** [EnterOnAction](enteronaction.md) > [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(EnterOnWhat)**
