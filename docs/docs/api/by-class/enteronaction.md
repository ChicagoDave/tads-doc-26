...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2389)


**Superclass chain:** [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **EnterOnActionSubclasses:** [predicate(EnterOn)](predicate%28enteron%29.md), [predicate(EnterOnWhat)](predicate%28enteronwhat%29.md)
