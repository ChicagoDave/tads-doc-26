...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 989)


Show the full score.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **FullScoreActionSubclasses:** [predicate(FullScore)](predicate%28fullscore%29.md)
...
Defined in actions.t, line 1010
...
Defined in actions.t, line 990


### `showFullScore`

Defined in actions.t, line 1000
