...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9883)


**Superclass chain:** [RestoreDefaultsAction](restoredefaultsaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(RestoreDefaults)**
...
Defined in en_us.t, line 9886


## Inherited Properties


*From [RestoreDefaultsAction](restoredefaultsaction.md):* [`includeInUndo`](restoredefaultsaction.md#includeInUndo)
...
*From [RestoreDefaultsAction](restoredefaultsaction.md):* [`execSystemAction`](restoredefaultsaction.md#execSystemAction)
