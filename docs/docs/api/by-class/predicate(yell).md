...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9587)


**Superclass chain:** [YellAction](yellaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Yell)**
...
*From [YellAction](yellaction.md):* [`execAction`](yellaction.md#execAction)
