...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5394)


**Superclass chain:** [ButPossessiveProd](butpossessiveprod.md) > [BasicPossessiveProd](basicpossessiveprod.md) > [DefiniteNounProd](definitenounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > [AmbigResponseKeeper](ambigresponsekeeper.md) > **exceptNounPhrase(singlePossessive)**
...
*From [ButPossessiveProd](butpossessiveprod.md):* [`resolveNouns`](butpossessiveprod.md#resolveNouns)
