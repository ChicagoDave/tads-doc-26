...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3703)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultGiveTopic**
...
Defined in actor.t, line 3704


### `matchScore` *(overridden)*

Defined in actor.t, line 3705
