...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9739)


**Superclass chain:** [WaitAction](waitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Wait)**
...
*From [WaitAction](waitaction.md):* [`execAction`](waitaction.md#execAction)
