...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10723)


**Superclass chain:** [ScrewWithAction](screwwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ScrewWith)**
...
Defined in en_us.t, line 10728


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10727


### `verbPhrase`

Defined in en_us.t, line 10726
...
*From [ScrewWithAction](screwwithaction.md):* [`getAllIobj`](screwwithaction.md#getAllIobj)
