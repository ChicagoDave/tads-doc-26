...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9557)


set up the empty direct object phrase


**Superclass chain:** [TopicsAction](topicsaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Topics)**
...
Defined in en_us.t, line 9560


## Inherited Properties


*From [TopicsAction](topicsaction.md):* [`includeInUndo`](topicsaction.md#includeInUndo)
...
*From [TopicsAction](topicsaction.md):* [`execSystemAction`](topicsaction.md#execSystemAction)
