...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10532)


**Superclass chain:** [LockWithAction](lockwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(LockWith)**
...
Defined in en_us.t, line 10537


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10538


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10536


### `verbPhrase`

Defined in en_us.t, line 10535


## Inherited Properties


*From [LockWithAction](lockwithaction.md):* [`resolveFirst`](lockwithaction.md#resolveFirst)
...
*From [LockWithAction](lockwithaction.md):* [`getAllIobj`](lockwithaction.md#getAllIobj)
