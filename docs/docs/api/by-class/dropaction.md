...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1770)


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **DropActionSubclasses:** [predicate(Drop)](predicate%28drop%29.md)
...
Defined in actions.t, line 1772
...
Defined in actions.t, line 1775
