...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10086)


**Superclass chain:** [JumpOffIAction](jumpoffiaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(JumpOffI)**
...
*From [JumpOffIAction](jumpoffiaction.md):* [`execAction`](jumpoffiaction.md#execAction)
