...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10450)


**Superclass chain:** [ClimbDownAction](climbdownaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ClimbDownWhat)**
...
Defined in en_us.t, line 10454


### `verbPhrase`

Defined in en_us.t, line 10453
