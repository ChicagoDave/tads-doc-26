...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10697)


set up the empty indirect object phrase


**Superclass chain:** [PlugInAction](pluginaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PlugIn)**
