...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10817)


**Superclass chain:** [OopsAction](oopsaction.md) > [LiteralAction](literalaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > **predicate(Oops)**


## Properties


### `verbPhrase` *(overridden)*

Defined in en_us.t, line 10820


## Inherited Properties


*From [OopsAction](oopsaction.md):* [`actionTime`](oopsaction.md#actionTime)


*From [LiteralAction](literalaction.md):* [`predicateNounPhrases`](literalaction.md#predicateNounPhrases)
...
*From [OopsAction](oopsaction.md):* [`execAction`](oopsaction.md#execAction)
...
<details><summary>From [Action](action.md) (94)</summary>
