...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10805)


**Superclass chain:** [HintsOffAction](hintsoffaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(HintsOff)**
...
*From [HintsOffAction](hintsoffaction.md):* [`execSystemAction`](hintsoffaction.md#execSystemAction)
