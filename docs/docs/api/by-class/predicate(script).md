...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9925)


**Superclass chain:** [ScriptAction](scriptaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Script)**
