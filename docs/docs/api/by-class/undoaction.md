...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 654)


Undo one turn.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **UndoActionSubclasses:** [predicate(Undo)](predicate%28undo%29.md)
