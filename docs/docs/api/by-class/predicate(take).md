...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9248)


Verbs.


**Superclass chain:** [TakeAction](takeaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Take)**
...
Defined in en_us.t, line 9252


## Inherited Properties


*From [TakeAction](takeaction.md):* [`actionAllowsAll`](takeaction.md#actionAllowsAll)


*From [TAction](taction.md):* [`actionDobjProp`](taction.md#actionDobjProp), [`actor_`](taction.md#actor_), [`askDobjResponseProd`](taction.md#askDobjResponseProd), [`checkDobjProp`](taction.md#checkDobjProp), [`dobjCur_`](taction.md#dobjCur_), [`dobjInfoCur_`](taction.md#dobjInfoCur_), [`dobjList_`](taction.md#dobjList_), [`dobjMatch`](taction.md#dobjMatch), [`dobjResolver_`](taction.md#dobjResolver_), [`issuer_`](taction.md#issuer_), [`preCondDobjProp`](taction.md#preCondDobjProp), [`predicateNounPhrases`](taction.md#predicateNounPhrases), [`remapDobjProp`](taction.md#remapDobjProp), [`verDobjProp`](taction.md#verDobjProp), [`whichMessageObject`](taction.md#whichMessageObject)
...
*From [TakeAction](takeaction.md):* [`getAllDobj`](takeaction.md#getAllDobj)
