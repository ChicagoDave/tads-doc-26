...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 842)


Pause the game. This stops the real-time clock until the user presses a key. Games that don't use the real-time clock will have no use for this.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **PauseActionSubclasses:** [predicate(Pause)](predicate%28pause%29.md)
