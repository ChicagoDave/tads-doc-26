...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10279)


**Superclass chain:** [ConsultAboutAction](consultaboutaction.md) > [TopicTAction](topictaction.md) > [TopicActionBase](topicactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(ConsultWhatAbout)**
...
Defined in en_us.t, line 10287


### `whichMessageTopic` *(overridden)*

Defined in en_us.t, line 10288


## Inherited Properties


*From [TopicTAction](topictaction.md):* [`needAnaphoricBinding_`](topictaction.md#needAnaphoricBinding_), [`predicateNounPhrases`](topictaction.md#predicateNounPhrases), [`topicList_`](topictaction.md#topicList_), [`topicResolver_`](topictaction.md#topicResolver_), [`whichMessageObject`](topictaction.md#whichMessageObject), [`whichObject`](topictaction.md#whichObject)
