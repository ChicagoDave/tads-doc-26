...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9377)


**Superclass chain:** [PutOnAction](putonaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PutOn)**
...
Defined in en_us.t, line 9383


### `verbPhrase`

Defined in en_us.t, line 9382


## Inherited Properties


*From [PutOnAction](putonaction.md):* [`actionAllowsAll`](putonaction.md#actionAllowsAll)
...
*From [PutOnAction](putonaction.md):* [`getAllDobj`](putonaction.md#getAllDobj)
