...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10550)


**Superclass chain:** [SitOnAction](sitonaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(SitOn)**
...
Defined in en_us.t, line 10555


### `verbPhrase`

Defined in en_us.t, line 10554
