...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3052)


**Superclass chain:** [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **PushTravelClimbUpActionSubclasses:** [predicate(PushTravelClimbUp)](predicate%28pushtravelclimbup%29.md)
...
Defined in actions.t, line 3054
