...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9745)


**Superclass chain:** [LookAction](lookaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Look)**
...
*From [LookAction](lookaction.md):* [`execAction`](lookaction.md#execAction)
