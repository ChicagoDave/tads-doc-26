...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3141)


hint system - disable hints for this session


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **HintsOffActionSubclasses:** [predicate(HintsOff)](predicate%28hintsoff%29.md)
...
Defined in actions.t, line 3142
