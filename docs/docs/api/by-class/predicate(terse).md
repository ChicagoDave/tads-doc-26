...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9817)


**Superclass chain:** [TerseAction](terseaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Terse)**
...
*From [TerseAction](terseaction.md):* [`execSystemAction`](terseaction.md#execSystemAction)
