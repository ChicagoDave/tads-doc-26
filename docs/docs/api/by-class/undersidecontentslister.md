...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4958)


basic contents lister for an Underside


**Superclass chain:** [ContentsLister](contentslister.md) > [Lister](lister.md) > `object` > [BaseUndersideContentsLister](baseundersidecontentslister.md) > [BaseContentsLister](basecontentslister.md) > **undersideContentsLister**
