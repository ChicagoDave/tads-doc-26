...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9787)


**Superclass chain:** [FootnotesStatusAction](footnotesstatusaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(FootnotesStatus)**
...
Defined in en_us.t, line 9790


## Inherited Properties


*From [FootnotesStatusAction](footnotesstatusaction.md):* [`includeInUndo`](footnotesstatusaction.md#includeInUndo)
...
*From [FootnotesStatusAction](footnotesstatusaction.md):* [`execSystemAction`](footnotesstatusaction.md#execSystemAction)
