...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1699)


let the actor handle it


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **TakeActionSubclasses:** [predicate(Take)](predicate%28take%29.md)


## Properties


### `actionAllowsAll` *(overridden)*

Defined in actions.t, line 1701
...
### `getAllDobj(actor, scopeList)` *(overridden)*

Defined in actions.t, line 1704
