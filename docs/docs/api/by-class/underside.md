...
*class* — defined in [extras.t](../by-file/extras.t.md) (line 822)
...
**Superclass chain:** [SpaceOverlay](spaceoverlay.md) > [BulkLimiter](bulklimiter.md) > [Thing](thing.md) > [VocabObject](vocabobject.md) > `object` > **UndersideSubclasses:** [RestrictedUnderside](restrictedunderside.md)
...
Defined in extras.t, line 838


### `actorInPrep` *(overridden)*

Defined in en_us.t, line 2109


### `actorOutOfPrep` *(overridden)*

Defined in en_us.t, line 2110


### `allowPutUnder`

Defined in extras.t, line 828

Can actors put new objects under self, using the PUT UNDER command? By default, we allow it. Override this property to nil if new objects cannot be added by player commands.


### `alreadyPutInMsg`

Defined in extras.t, line 859
...
Defined in extras.t, line 835


### `inlineContentsLister` *(overridden)*

Defined in extras.t, line 837


### `lookInLister` *(overridden)*

Defined in extras.t, line 836


### `objInPrep` *(overridden)*

Defined in en_us.t, line 2108


### `putDestMessage`

Defined in extras.t, line 847
...
Defined in extras.t, line 897

Looking "under" a surface simply shows the surface's contents.


### `iobjFor(PutUnder)` *(overridden)*

Defined in extras.t, line 868
