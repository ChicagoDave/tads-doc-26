...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 802)


Quit the game.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **QuitActionSubclasses:** [predicate(Quit)](predicate%28quit%29.md)
...
Defined in actions.t, line 803


### `terminateGame`

Defined in actions.t, line 824

Carry out game termination. This can be called when we wish to end the game without asking for any additional player confirmation.
