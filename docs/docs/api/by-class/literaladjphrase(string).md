...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6511)


**Superclass chain:** [AdjPhraseWithVocab](adjphrasewithvocab.md) > [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **literalAdjPhrase(string)**
