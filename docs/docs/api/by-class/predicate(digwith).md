...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10071)


**Superclass chain:** [DigWithAction](digwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(DigWith)**
...
Defined in en_us.t, line 10076


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10077


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10075


### `verbPhrase`

Defined in en_us.t, line 10074
...
*From [DigWithAction](digwithaction.md):* [`getAllIobj`](digwithaction.md#getAllIobj)
