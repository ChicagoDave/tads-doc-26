...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9973)


**Superclass chain:** [ReplayStringAction](replaystringaction.md) > [ReplayAction](replayaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(ReplayString)**


## Properties


### `scriptOptionFlags` *(overridden)*

Defined in en_us.t, line 9980
...
Defined in en_us.t, line 9977


## Inherited Properties


*From [ReplayAction](replayaction.md):* [`fileDisposition`](replayaction.md#fileDisposition), [`filePromptMsg`](replayaction.md#filePromptMsg), [`fileTypeID`](replayaction.md#fileTypeID)
...
*From [ReplayStringAction](replaystringaction.md):* [`execSystemAction`](replaystringaction.md#execSystemAction)


*From [ReplayAction](replayaction.md):* [`performFileOp`](replayaction.md#performFileOp), [`showCancelMsg`](replayaction.md#showCancelMsg)
