...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10184)


**Superclass chain:** [TypeLiteralOnAction](typeliteralonaction.md) > [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(TypeLiteralOn)**
...
Defined in en_us.t, line 10188


### `verbPhrase`

Defined in en_us.t, line 10187
