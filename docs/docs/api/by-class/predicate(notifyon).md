...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9841)


**Superclass chain:** [NotifyOnAction](notifyonaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(NotifyOn)**
...
*From [NotifyOnAction](notifyonaction.md):* [`execSystemAction`](notifyonaction.md#execSystemAction)
