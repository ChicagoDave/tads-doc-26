...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9733)


**Superclass chain:** [InventoryWideAction](inventorywideaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(InventoryWide)**
...
*From [InventoryWideAction](inventorywideaction.md):* [`execAction`](inventorywideaction.md#execAction)
