...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 2258)
...
**Superclass chain:** [npcMessages](npcmessages.md) > [playerMessages](playermessages.md) > [libMessages](libmessages.md) > [MessageHelper](messagehelper.md) > `object` > **npcMessagesDirect**
...
Defined in msg_neu.t, line 2380
...
Defined in msg_neu.t, line 2345
...
Defined in msg_neu.t, line 2389
...
Defined in msg_neu.t, line 2409
...
Defined in msg_neu.t, line 2326
...
Defined in msg_neu.t, line 2290
...
Defined in msg_neu.t, line 2402


### `missingObject(actor, action, which)`

Defined in msg_neu.t, line 2396


### `noMatchCannotSee(actor, txt)`

Defined in msg_neu.t, line 2260
...
Defined in msg_neu.t, line 2311
...
Defined in msg_neu.t, line 2271
...
Defined in msg_neu.t, line 2277
...
Defined in msg_neu.t, line 2265


### `singleObjectRequired(actor, txt)`

Defined in msg_neu.t, line 2304
...
Defined in msg_neu.t, line 2297
...
Defined in msg_neu.t, line 2416
...
Defined in msg_neu.t, line 2283
...
*From [npcMessages](npcmessages.md):* [`commandNotHeard`](npcmessages.md#commandNotHeard)


*From [playerMessages](playermessages.md):* [`allNotAllowed`](playermessages.md#allNotAllowed), [`askMissingLiteral`](playermessages.md#askMissingLiteral), [`cannotAddressMultiple`](playermessages.md#cannotAddressMultiple), [`cannotChangeActor`](playermessages.md#cannotChangeActor), [`commandNotUnderstood`](playermessages.md#commandNotUnderstood), [`emptyNounPhrase`](playermessages.md#emptyNounPhrase), [`explainCancelCommandLine`](playermessages.md#explainCancelCommandLine), [`missingActor`](playermessages.md#missingActor), [`noMatch`](playermessages.md#noMatch), [`noMatchForListBut`](playermessages.md#noMatchForListBut), [`noMatchForLocation`](playermessages.md#noMatchForLocation), [`noMatchForPluralPossessive`](playermessages.md#noMatchForPluralPossessive), [`noMatchForPossessive`](playermessages.md#noMatchForPossessive), [`noMatchForPronoun`](playermessages.md#noMatchForPronoun), [`nothingInLocation`](playermessages.md#nothingInLocation), [`reflexiveNotAllowed`](playermessages.md#reflexiveNotAllowed), [`refuseCommandBusy`](playermessages.md#refuseCommandBusy), [`singleActorRequired`](playermessages.md#singleActorRequired), [`specialTopicInactive`](playermessages.md#specialTopicInactive), [`wrongReflexive`](playermessages.md#wrongReflexive)
