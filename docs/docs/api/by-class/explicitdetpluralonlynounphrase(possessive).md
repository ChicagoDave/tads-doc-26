...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5991)


**Superclass chain:** [PossessivePluralProd](possessivepluralprod.md) > [BasicPossessiveProd](basicpossessiveprod.md) > [DefiniteNounProd](definitenounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > [AmbigResponseKeeper](ambigresponsekeeper.md) > **explicitDetPluralOnlyNounPhrase(possessive)**
...
*From [PossessivePluralProd](possessivepluralprod.md):* [`resolveNouns`](possessivepluralprod.md#resolveNouns)
