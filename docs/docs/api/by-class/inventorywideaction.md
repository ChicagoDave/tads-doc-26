...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1663)


run the inventory action


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **InventoryWideActionSubclasses:** [predicate(InventoryWide)](predicate%28inventorywide%29.md)
...
Defined in actions.t, line 1664
