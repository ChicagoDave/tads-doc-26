...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9994)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Travel)**
