...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6200)


just a noun


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simpleNounPhrase(noun)**
...
Defined in en_us.t, line 6206


### `getVocabMatchList(resolver, results, extraFlags)` *(overridden)*

Defined in en_us.t, line 6202
