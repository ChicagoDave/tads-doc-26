...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10758)


**Superclass chain:** [PushTravelEnterAction](pushtravelenteraction.md) > [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **predicate(PushTravelEnter)**
...
*From [PushTravelEnterAction](pushtravelenteraction.md):* [`performTravel`](pushtravelenteraction.md#performTravel)
