...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9600)


**Superclass chain:** [GiveToAction](givetoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(GiveToType2)**
...
Defined in en_us.t, line 9604


### `isPrepositionalPhrasing` *(overridden)*

Defined in en_us.t, line 9607
