...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9769)


**Superclass chain:** [FootnotesFullAction](footnotesfullaction.md) > [FootnotesAction](footnotesaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(FootnotesFull)**
...
Defined in en_us.t, line 9772


## Inherited Properties


*From [FootnotesFullAction](footnotesfullaction.md):* [`showFootnotes`](footnotesfullaction.md#showFootnotes)
