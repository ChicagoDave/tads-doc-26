...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9569)


**Superclass chain:** [GoodbyeAction](goodbyeaction.md) > [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Goodbye)**
...
*From [GoodbyeAction](goodbyeaction.md):* [`execAction`](goodbyeaction.md#execAction)


*From [ConvIAction](conviaction.md):* [`isConversational`](conviaction.md#isConversational)


*From [IAction](iaction.md):* [`doActionMain`](iaction.md#doActionMain), [`resolveNouns`](iaction.md#resolveNouns)


<details><summary>From [Action](action.md) (99)</summary>
