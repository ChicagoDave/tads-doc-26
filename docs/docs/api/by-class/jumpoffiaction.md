...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2336)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **JumpOffIActionSubclasses:** [predicate(JumpOffI)](predicate%28jumpoffi%29.md)
...
Defined in actions.t, line 2337
