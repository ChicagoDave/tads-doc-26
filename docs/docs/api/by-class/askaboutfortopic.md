...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3021)


A combination ASK ABOUT and ASK FOR topic.


**Superclass chain:** [AskTellTopic](asktelltopic.md) > [TopicMatchTopic](topicmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **AskAboutForTopic**
