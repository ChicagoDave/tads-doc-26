...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2299)


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **ThrowDirActionSubclasses:** [predicate(ThrowDir)](predicate%28throwdir%29.md), [predicate(ThrowDirDown)](predicate%28throwdirdown%29.md)
...
Defined in actions.t, line 2301
