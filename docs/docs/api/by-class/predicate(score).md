...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9823)


**Superclass chain:** [ScoreAction](scoreaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Score)**
...
Defined in en_us.t, line 9826


## Inherited Properties


*From [ScoreAction](scoreaction.md):* [`includeInUndo`](scoreaction.md#includeInUndo), [`mentionedFullScore`](scoreaction.md#mentionedFullScore)
...
*From [ScoreAction](scoreaction.md):* [`execSystemAction`](scoreaction.md#execSystemAction)
