...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9802)


**Superclass chain:** [TipModeAction](tipmodeaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(TipsOff)**
...
Defined in en_us.t, line 9806


### `verbPhrase`

Defined in en_us.t, line 9808
...
*From [TipModeAction](tipmodeaction.md):* [`execSystemAction`](tipmodeaction.md#execSystemAction)
