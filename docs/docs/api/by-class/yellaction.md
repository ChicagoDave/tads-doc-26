...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2128)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **YellActionSubclasses:** [predicate(Yell)](predicate%28yell%29.md)
...
Defined in actions.t, line 2129
