...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2822)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **InActionSubclasses:** [predicate(In)](predicate%28in%29.md)
...
Defined in actions.t, line 2823
