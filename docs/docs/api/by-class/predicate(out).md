...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10034)


**Superclass chain:** [OutAction](outaction.md) > [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Out)**
...
Defined in en_us.t, line 10038


## Inherited Properties


*From [OutAction](outaction.md):* [`getDirection`](outaction.md#getDirection)
