...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2250)


it's not ours


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **ShowToActionSubclasses:** [predicate(ShowTo)](predicate%28showto%29.md), [predicate(ShowToType2)](predicate%28showtotype2%29.md), [predicate(ShowToWhom)](predicate%28showtowhom%29.md)
...
### `getDefaultIobj(np, resolver)` *(overridden)*

Defined in actions.t, line 2251
