...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9835)


**Superclass chain:** [NotifyAction](notifyaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Notify)**
...
*From [NotifyAction](notifyaction.md):* [`execSystemAction`](notifyaction.md#execSystemAction)
