...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9955)


**Superclass chain:** [RecordEventsAction](recordeventsaction.md) > [RecordAction](recordaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(RecordEvents)**
...
Defined in en_us.t, line 9958


## Inherited Properties


*From [RecordEventsAction](recordeventsaction.md):* [`logFileType`](recordeventsaction.md#logFileType)
