...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9313)


**Superclass chain:** [LookBehindAction](lookbehindaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(LookBehind)**
