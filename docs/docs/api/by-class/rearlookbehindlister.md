...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4997)


contents lister for explicitly looking behind a RearContainer/Surface


**Superclass chain:** [LookWhereContentsLister](lookwherecontentslister.md) > [DescContentsLister](desccontentslister.md) > [Lister](lister.md) > `object` > [BaseRearContentsLister](baserearcontentslister.md) > [BaseContentsLister](basecontentslister.md) > **rearLookBehindLister**
