...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10443)


**Superclass chain:** [ClimbDownAction](climbdownaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ClimbDown)**
...
Defined in en_us.t, line 10447


### `verbPhrase`

Defined in en_us.t, line 10446
