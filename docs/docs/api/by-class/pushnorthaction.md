...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2948)


To make it easy to synthesize actions for pushing objects, define individual subclasses for the various directions.


**Superclass chain:** [PushTravelDirAction](pushtraveldiraction.md) > [PushTravelAction](pushtravelaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **PushNorthAction**
...
Defined in actions.t, line 2949
...
*From [PushTravelDirAction](pushtraveldiraction.md):* [`getDirection`](pushtraveldiraction.md#getDirection), [`performTravel`](pushtraveldiraction.md#performTravel)
