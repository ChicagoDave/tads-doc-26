...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2374)


**Superclass chain:** [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **TurnToActionSubclasses:** [predicate(TurnTo)](predicate%28turnto%29.md)
