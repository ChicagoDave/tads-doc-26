...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9688)


a special rule for THROW DOWN <dobj>


**Superclass chain:** [ThrowDirAction](throwdiraction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(ThrowDirDown)**
