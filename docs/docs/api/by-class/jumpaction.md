...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2321)


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **JumpActionSubclasses:** [predicate(Jump)](predicate%28jump%29.md)
...
Defined in actions.t, line 2322
...
Defined in actions.t, line 2323
