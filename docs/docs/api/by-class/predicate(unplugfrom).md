...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10704)


**Superclass chain:** [UnplugFromAction](unplugfromaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(UnplugFrom)**
...
Defined in en_us.t, line 10708


### `verbPhrase`

Defined in en_us.t, line 10707
