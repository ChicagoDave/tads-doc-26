...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10781)


**Superclass chain:** [PushTravelClimbDownAction](pushtravelclimbdownaction.md) > [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **predicate(PushTravelClimbDown)**
...
*From [PushTravelClimbDownAction](pushtravelclimbdownaction.md):* [`performTravel`](pushtravelclimbdownaction.md#performTravel)
