...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 7072)


Explicitly match a miscellaneous word list as a topic.


**Superclass chain:** [TopicProd](topicprod.md) > [SingleNounProd](singlenounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **topicPhrase(misc)**
