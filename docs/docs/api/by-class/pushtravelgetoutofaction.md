...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3047)


**Superclass chain:** [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **PushTravelGetOutOfActionSubclasses:** [predicate(PushTravelGetOutOf)](predicate%28pushtravelgetoutof%29.md)
...
Defined in actions.t, line 3049
