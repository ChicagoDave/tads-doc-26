...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1066)


Show version information for the game and the library modules the game is using.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **VersionActionSubclasses:** [predicate(Version)](predicate%28version%29.md)
...
Defined in actions.t, line 1075
...
Defined in actions.t, line 1067
