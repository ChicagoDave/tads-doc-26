...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6998)


An "adjective phrase" is a phrase made entirely of adjectives.


**Superclass chain:** [AdjPhraseWithVocab](adjphrasewithvocab.md) > [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **adjPhrase(adj)**
