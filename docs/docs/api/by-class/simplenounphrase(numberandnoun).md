...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6287)


<literal-adjective> <noun> (for things like "board 44 bus" or 'push "G" button')


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simpleNounPhrase(numberAndNoun)**
