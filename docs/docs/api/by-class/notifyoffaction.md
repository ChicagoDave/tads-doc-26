...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1048)


Turn score change notifications off.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **NotifyOffActionSubclasses:** [predicate(NotifyOff)](predicate%28notifyoff%29.md)
...
Defined in actions.t, line 1049
