...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4977)


contents lister for an Underside, used in a long description


**Superclass chain:** [DescContentsLister](desccontentslister.md) > [Lister](lister.md) > `object` > [BaseUndersideContentsLister](baseundersidecontentslister.md) > [BaseContentsLister](basecontentslister.md) > **undersideDescContentsLister**
...
Defined in msg_neu.t, line 4978
