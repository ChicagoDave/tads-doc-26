...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10823)


**Superclass chain:** [OopsIAction](oopsiaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(OopsOnly)**
...
Defined in en_us.t, line 10826


## Inherited Properties


*From [OopsIAction](oopsiaction.md):* [`actionTime`](oopsiaction.md#actionTime)
...
*From [OopsIAction](oopsiaction.md):* [`doActionMain`](oopsiaction.md#doActionMain)


*From [IAction](iaction.md):* [`resolveNouns`](iaction.md#resolveNouns)
