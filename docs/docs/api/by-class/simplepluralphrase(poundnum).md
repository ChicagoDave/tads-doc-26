...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6905)


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simplePluralPhrase(poundNum)**
