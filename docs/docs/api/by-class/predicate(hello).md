...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9563)


**Superclass chain:** [HelloAction](helloaction.md) > [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Hello)**
...
*From [HelloAction](helloaction.md):* [`execAction`](helloaction.md#execAction)
