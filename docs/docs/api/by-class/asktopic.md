...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 2998)


An ASK ABOUT topic database entry. This type of topic is included in the ASK ABOUT list only.


**Superclass chain:** [AskTellTopic](asktelltopic.md) > [TopicMatchTopic](topicmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **AskTopic**
