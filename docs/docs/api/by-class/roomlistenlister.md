...
*object* — defined in [lister.t](../by-file/lister.t.md) (line 1790)


Room contents lister for things that can be heard.


**Superclass chain:** [SenseLister](senselister.md) > [ParagraphLister](paragraphlister.md) > [Lister](lister.md) > `object` > **roomListenLister**
