...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9877)


**Superclass chain:** [SaveDefaultsAction](savedefaultsaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(SaveDefaults)**
...
Defined in en_us.t, line 9880


## Inherited Properties


*From [SaveDefaultsAction](savedefaultsaction.md):* [`includeInUndo`](savedefaultsaction.md#includeInUndo)
...
*From [SaveDefaultsAction](savedefaultsaction.md):* [`execSystemAction`](savedefaultsaction.md#execSystemAction)
