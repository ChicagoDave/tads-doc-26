...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3090)
...
**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ExitsModeActionSubclasses:** [predicate(ExitsMode)](predicate%28exitsmode%29.md)
...
Defined in actions.t, line 3091
