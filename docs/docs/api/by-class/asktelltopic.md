...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 2989)


A dual ASK/TELL topic database entry. This type of topic is included in both the ASK ABOUT and TELL ABOUT lists.


**Superclass chain:** [TopicMatchTopic](topicmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **AskTellTopicSubclasses:** [AskAboutForTopic](askaboutfortopic.md), [AskForTopic](askfortopic.md), [AskTellAboutForTopic](asktellaboutfortopic.md), [AskTopic](asktopic.md), [TellTopic](telltopic.md)
