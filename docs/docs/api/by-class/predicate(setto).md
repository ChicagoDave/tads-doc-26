...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10170)


**Superclass chain:** [SetToAction](settoaction.md) > [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(SetTo)**
...
Defined in en_us.t, line 10174


### `omitIobjInDobjQuery`

Defined in en_us.t, line 10175


### `verbPhrase`

Defined in en_us.t, line 10173
