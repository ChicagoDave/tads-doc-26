...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3066)


The "exits" verb. This verb explicitly shows all of the exits from the current location.


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **ExitsActionSubclasses:** [predicate(Exits)](predicate%28exits%29.md)
...
Defined in actions.t, line 3067
