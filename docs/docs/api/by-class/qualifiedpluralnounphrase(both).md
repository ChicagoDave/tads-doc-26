...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 5881)


plural phrase qualified with "both"


**Superclass chain:** [BothPluralProd](bothpluralprod.md) > [ExactQuantifiedPluralProd](exactquantifiedpluralprod.md) > [QuantifiedPluralProd](quantifiedpluralprod.md) > [PluralProd](pluralprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > [AmbigResponseKeeper](ambigresponsekeeper.md) > **qualifiedPluralNounPhrase(both)**
...
*From [BothPluralProd](bothpluralprod.md):* [`getQuantity`](bothpluralprod.md#getQuantity)
