...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9907)


**Superclass chain:** [VersionAction](versionaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Version)**
...
Defined in en_us.t, line 9910


## Inherited Properties


*From [VersionAction](versionaction.md):* [`includeInUndo`](versionaction.md#includeInUndo)
...
*From [VersionAction](versionaction.md):* [`execSystemAction`](versionaction.md#execSystemAction)
