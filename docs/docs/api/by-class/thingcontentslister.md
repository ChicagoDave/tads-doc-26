...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4756)


Contents lister for things. This is used to display the second-level contents lists for things listed in the top-level list for a room description, inventory listing, or object description.


**Superclass chain:** [ContentsLister](contentslister.md) > [Lister](lister.md) > `object` > [BaseThingContentsLister](basethingcontentslister.md) > **thingContentsLister**
