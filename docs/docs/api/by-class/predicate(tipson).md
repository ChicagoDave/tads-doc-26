...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9793)


**Superclass chain:** [TipModeAction](tipmodeaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(TipsOn)**
...
Defined in en_us.t, line 9797


### `verbPhrase`

Defined in en_us.t, line 9799
