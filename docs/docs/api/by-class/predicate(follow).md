...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9697)


**Superclass chain:** [FollowAction](followaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Follow)**
...
Defined in en_us.t, line 9701


### `verbPhrase`

Defined in en_us.t, line 9700
...
*From [FollowAction](followaction.md):* [`initResolver`](followaction.md#initResolver)
