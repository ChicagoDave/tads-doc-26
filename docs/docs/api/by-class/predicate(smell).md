...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9331)


**Superclass chain:** [SmellAction](smellaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Smell)**
...
Defined in en_us.t, line 9341

use the "not aware" version of the no-match message - the object of SMELL is often intangible, so the default "you can't see that" message is often incongruous for this verb
