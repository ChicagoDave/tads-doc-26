...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9651)


set up the empty indirect object phrase


**Superclass chain:** [ThrowAction](throwaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Throw)**
