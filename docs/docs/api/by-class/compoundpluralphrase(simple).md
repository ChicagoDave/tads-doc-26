...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6141)


just a single plural phrase


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **compoundPluralPhrase(simple)**
...
Defined in en_us.t, line 6147


### `getVocabMatchList(resolver, results, extraFlags)` *(overridden)*

Defined in en_us.t, line 6143
