...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2139)


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **TopicsActionSubclasses:** [predicate(Topics)](predicate%28topics%29.md)
...
Defined in actions.t, line 2156
...
Defined in actions.t, line 2140
