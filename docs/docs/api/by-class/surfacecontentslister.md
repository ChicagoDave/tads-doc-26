...
*object* — defined in [msg_neu.t](../by-file/msg_neu.t.md) (line 4895)


Contents lister for a surface


**Superclass chain:** [ContentsLister](contentslister.md) > [Lister](lister.md) > `object` > [BaseSurfaceContentsLister](basesurfacecontentslister.md) > [BaseContentsLister](basecontentslister.md) > **surfaceContentsLister**
