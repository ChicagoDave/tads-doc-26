...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2840)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **PortActionSubclasses:** [predicate(Port)](predicate%28port%29.md)
...
Defined in actions.t, line 2841
