...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2825)


**Superclass chain:** [TravelAction](travelaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **OutActionSubclasses:** [predicate(Out)](predicate%28out%29.md)
...
Defined in actions.t, line 2826
