...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10671)


**Superclass chain:** [UnfastenFromAction](unfastenfromaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(UnfastenFrom)**
...
Defined in en_us.t, line 10675


### `verbPhrase`

Defined in en_us.t, line 10674
