...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3042)


**Superclass chain:** [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **PushTravelEnterActionSubclasses:** [predicate(PushTravelEnter)](predicate%28pushtravelenter%29.md)
...
Defined in actions.t, line 3044
