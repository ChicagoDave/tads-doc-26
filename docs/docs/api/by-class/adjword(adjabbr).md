...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6693)


**Superclass chain:** [AdjPhraseWithVocab](adjphrasewithvocab.md) > [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **adjWord(adjAbbr)**
...
Defined in en_us.t, line 6705

return the list matching our adjective *with* the period attached; the period is part of the dictionary entry for an abbreviated word


### `getVocabMatchList(resolver, results, extraFlags)` *(overridden)*

Defined in en_us.t, line 6695
