...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2011)


the issuing actor is saying yes to the target actor


**Superclass chain:** [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **NoActionSubclasses:** [predicate(No)](predicate%28no%29.md)
...
Defined in actions.t, line 2012
