...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2992)


**Superclass chain:** [PushTravelDirAction](pushtraveldiraction.md) > [PushTravelAction](pushtravelaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **PushOutAction**
...
Defined in actions.t, line 2993
