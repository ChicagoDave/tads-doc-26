...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2756)


for a vague command such as GO, which doesn't say where to go


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **VagueTravelActionSubclasses:** [predicate(VagueTravel)](predicate%28vaguetravel%29.md)
...
Defined in actions.t, line 2757
