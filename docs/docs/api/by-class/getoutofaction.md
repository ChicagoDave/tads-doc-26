...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2609)


**Superclass chain:** [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **GetOutOfActionSubclasses:** [predicate(GetOutOf)](predicate%28getoutof%29.md)
...
Defined in actions.t, line 2610
