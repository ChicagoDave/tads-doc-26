...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10678)


**Superclass chain:** [PlugIntoAction](plugintoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(PlugInto)**
...
Defined in en_us.t, line 10682


### `verbPhrase`

Defined in en_us.t, line 10681
