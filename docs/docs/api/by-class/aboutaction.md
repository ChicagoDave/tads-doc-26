...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1097)


Show the "about" information for the game and library modules.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **AboutActionSubclasses:** [predicate(About)](predicate%28about%29.md)
...
Defined in actions.t, line 1120
...
Defined in actions.t, line 1098
