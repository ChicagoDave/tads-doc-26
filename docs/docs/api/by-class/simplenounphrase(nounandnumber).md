...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 6314)


<noun> <literal-adjective> (for things like "press button 3" or 'put tab "A" in slot "B"')


**Superclass chain:** [NounPhraseWithVocab](nounphrasewithvocab.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **simpleNounPhrase(nounAndNumber)**
