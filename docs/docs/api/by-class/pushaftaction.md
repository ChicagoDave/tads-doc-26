...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3000)


**Superclass chain:** [PushTravelDirAction](pushtraveldiraction.md) > [PushTravelAction](pushtravelaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **PushAftAction**
...
Defined in actions.t, line 3001
