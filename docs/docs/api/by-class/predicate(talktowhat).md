...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9543)


**Superclass chain:** [TalkToAction](talktoaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(TalkToWhat)**
...
Defined in en_us.t, line 9547


### `verbPhrase`

Defined in en_us.t, line 9546
