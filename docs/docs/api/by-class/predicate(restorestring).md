...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9871)


**Superclass chain:** [RestoreStringAction](restorestringaction.md) > [RestoreAction](restoreaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(RestoreString)**
...
Defined in en_us.t, line 9874


## Inherited Properties


*From [RestoreAction](restoreaction.md):* [`includeInUndo`](restoreaction.md#includeInUndo)
...
*From [RestoreStringAction](restorestringaction.md):* [`execSystemAction`](restorestringaction.md#execSystemAction)


*From [RestoreAction](restoreaction.md):* [`askAndRestore`](restoreaction.md#askAndRestore), [`performRestore`](restoreaction.md#performRestore), [`startupRestore`](restoreaction.md#startupRestore)
