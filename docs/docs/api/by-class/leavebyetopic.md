...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3432)


A "leaving" goodbye topic. This handles ONLY goodbyes that happen when the PC walks away from the actor they're talking to.


**Superclass chain:** [MiscTopic](misctopic.md) > [TopicEntry](topicentry.md) > `object` > **LeaveByeTopic**
...
Defined in actor.t, line 3433


### `matchList`

Defined in actor.t, line 3434


### `matchScore` *(overridden)*

Defined in actor.t, line 3435
