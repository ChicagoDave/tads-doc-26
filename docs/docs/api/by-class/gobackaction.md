...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2878)


"go back"


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **GoBackActionSubclasses:** [predicate(GoBack)](predicate%28goback%29.md)
...
Defined in actions.t, line 2879
