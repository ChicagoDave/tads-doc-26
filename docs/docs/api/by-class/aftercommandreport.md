...
*class* — defined in [report.t](../by-file/report.t.md) (line 256)


"after" report - these come after the main report


**Superclass chain:** [FullCommandReport](fullcommandreport.md) > [CommandReportMessage](commandreportmessage.md) > [CommandReport](commandreport.md) > `object` > [MessageResult](messageresult.md) > **AfterCommandReport**
