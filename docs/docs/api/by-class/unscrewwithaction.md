...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2671)


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **UnscrewWithActionSubclasses:** [predicate(UnscrewWith)](predicate%28unscrewwith%29.md)
...
Defined in actions.t, line 2673
