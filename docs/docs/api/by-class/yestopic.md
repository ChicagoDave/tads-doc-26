...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3524)


**Superclass chain:** [YesNoTopic](yesnotopic.md) > [MiscTopic](misctopic.md) > [TopicEntry](topicentry.md) > `object` > **YesTopic**


## Properties


### `matchList` *(overridden)*

Defined in actor.t, line 3525


## Inherited Properties


*From [YesNoTopic](yesnotopic.md):* [`includeInList`](yesnotopic.md#includeInList)
