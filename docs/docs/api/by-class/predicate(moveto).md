...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10124)


**Superclass chain:** [MoveToAction](movetoaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(MoveTo)**
...
Defined in en_us.t, line 10128


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10129


### `verbPhrase`

Defined in en_us.t, line 10127
