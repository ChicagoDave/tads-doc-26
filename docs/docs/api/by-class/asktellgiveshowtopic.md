...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3186)


A combined ASK/TELL/GIVE/SHOW topic.


**Superclass chain:** [TopicOrThingMatchTopic](topicorthingmatchtopic.md) > [ThingMatchTopic](thingmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > [TopicMatchTopic](topicmatchtopic.md) > **AskTellGiveShowTopic**
