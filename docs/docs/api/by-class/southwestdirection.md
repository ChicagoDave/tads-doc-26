...
*object* — defined in [travel.t](../by-file/travel.t.md) (line 173)


**Superclass chain:** [CompassDirection](compassdirection.md) > [Direction](direction.md) > `object` > **southwestDirection**
...
*From [CompassDirection](compassdirection.md):* [`sayArriving`](compassdirection.md#sayArriving), [`sayDeparting`](compassdirection.md#sayDeparting)
