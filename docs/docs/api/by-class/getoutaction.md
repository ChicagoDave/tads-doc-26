...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 2625)


'all' for 'get off of' is the actor's immediate container


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **GetOutActionSubclasses:** [predicate(GetOut)](predicate%28getout%29.md)
...
Defined in actions.t, line 2626
