...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9961)


**Superclass chain:** [RecordEventsStringAction](recordeventsstringaction.md) > [RecordStringAction](recordstringaction.md) > [RecordAction](recordaction.md) > [FileOpAction](fileopaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(RecordEventsString)**
...
Defined in en_us.t, line 9964


## Inherited Properties


*From [RecordEventsStringAction](recordeventsstringaction.md):* [`logFileType`](recordeventsstringaction.md#logFileType)


*From [RecordAction](recordaction.md):* [`fileDisposition`](recordaction.md#fileDisposition), [`filePromptMsg`](recordaction.md#filePromptMsg), [`fileTypeID`](recordaction.md#fileTypeID)


*From [FileOpAction](fileopaction.md):* [`includeInUndo`](fileopaction.md#includeInUndo), [`isRepeatable`](fileopaction.md#isRepeatable), [`showCancelMsg`](fileopaction.md#showCancelMsg)
...
*From [RecordStringAction](recordstringaction.md):* [`execSystemAction`](recordstringaction.md#execSystemAction)


*From [RecordAction](recordaction.md):* [`performFileOp`](recordaction.md#performFileOp), [`setUpRecording`](recordaction.md#setUpRecording), [`showCancelMsg`](recordaction.md#showCancelMsg)


*From [FileOpAction](fileopaction.md):* [`setUpFileOp`](fileopaction.md#setUpFileOp)
