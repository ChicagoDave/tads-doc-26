...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9344)


**Superclass chain:** [SmellImplicitAction](smellimplicitaction.md) > [SenseImplicitAction](senseimplicitaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(SmellImplicit)**
...
Defined in en_us.t, line 9347


## Inherited Properties


*From [SmellImplicitAction](smellimplicitaction.md):* [`defaultMsgProp`](smellimplicitaction.md#defaultMsgProp), [`descProp`](smellimplicitaction.md#descProp), [`mySense`](smellimplicitaction.md#mySense), [`resultLister`](smellimplicitaction.md#resultLister)
