...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9757)


**Superclass chain:** [AgainAction](againaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Again)**
...
Defined in en_us.t, line 9760


## Inherited Properties


*From [AgainAction](againaction.md):* [`actionTime`](againaction.md#actionTime), [`includeInUndo`](againaction.md#includeInUndo), [`isRepeatable`](againaction.md#isRepeatable), [`lastAction`](againaction.md#lastAction), [`lastIssuingActor`](againaction.md#lastIssuingActor), [`lastTargetActor`](againaction.md#lastTargetActor), [`lastTargetActorPhrase`](againaction.md#lastTargetActorPhrase)
...
*From [AgainAction](againaction.md):* [`clearForAgain`](againaction.md#clearForAgain), [`doAction`](againaction.md#doAction), [`saveForAgain`](againaction.md#saveForAgain)
