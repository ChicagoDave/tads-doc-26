...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3127)


intransitive form of "oops"


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **OopsIActionSubclasses:** [predicate(OopsOnly)](predicate%28oopsonly%29.md)
...
Defined in actions.t, line 3135
...
Defined in actions.t, line 3128
