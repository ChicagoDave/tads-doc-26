...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10203)


set up the empty direct object phrase


**Superclass chain:** [EnterOnAction](enteronaction.md) > [LiteralTAction](literaltaction.md) > [LiteralActionBase](literalactionbase.md) > `object` > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > [Resolver](resolver.md) > **predicate(EnterOn)**
...
Defined in en_us.t, line 10208


### `verbPhrase`

Defined in en_us.t, line 10207
