...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10417)


**Superclass chain:** [ClimbAction](climbaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Climb)**
...
Defined in en_us.t, line 10421


### `verbPhrase`

Defined in en_us.t, line 10420
