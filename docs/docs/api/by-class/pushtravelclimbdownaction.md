...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 3057)


**Superclass chain:** [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **PushTravelClimbDownActionSubclasses:** [predicate(PushTravelClimbDown)](predicate%28pushtravelclimbdown%29.md)
...
Defined in actions.t, line 3059
