...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9721)


**Superclass chain:** [InventoryAction](inventoryaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Inventory)**
...
Defined in en_us.t, line 9724


## Inherited Properties


*From [InventoryAction](inventoryaction.md):* [`inventoryMode`](inventoryaction.md#inventoryMode)
...
*From [InventoryAction](inventoryaction.md):* [`execAction`](inventoryaction.md#execAction)
