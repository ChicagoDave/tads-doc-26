...
*grammar* — defined in [instruct.t](../by-file/instruct.t.md) (line 1000)


define the INSTRUCTIONS command's grammar


**Superclass chain:** [InstructionsAction](instructionsaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(instructions)**


## Inherited Properties


*From [InstructionsAction](instructionsaction.md):* [`allRequiredVerbsDisclosed`](instructionsaction.md#allRequiredVerbsDisclosed), [`conversationAbbr`](instructionsaction.md#conversationAbbr), [`conversationInstructions`](instructionsaction.md#conversationInstructions), [`conversationVerbs`](instructionsaction.md#conversationVerbs), [`crueltyLevel`](instructionsaction.md#crueltyLevel), [`customVerbs`](instructionsaction.md#customVerbs), [`includeInUndo`](instructionsaction.md#includeInUndo), [`isRealTime`](instructionsaction.md#isRealTime), [`isRepeatable`](instructionsaction.md#isRepeatable), [`truncationLength`](instructionsaction.md#truncationLength)
...
*From [InstructionsAction](instructionsaction.md):* [`execSystemAction`](instructionsaction.md#execSystemAction), [`showAbbrevChapter`](instructionsaction.md#showAbbrevChapter), [`showAdvancedCmdChapter`](instructionsaction.md#showAdvancedCmdChapter), [`showAmbiguousCmdChapter`](instructionsaction.md#showAmbiguousCmdChapter), [`showCommandsChapter`](instructionsaction.md#showCommandsChapter), [`showConversationChapter`](instructionsaction.md#showConversationChapter), [`showInstructions`](instructionsaction.md#showInstructions), [`showObjectsChapter`](instructionsaction.md#showObjectsChapter), [`showSaveRestoreChapter`](instructionsaction.md#showSaveRestoreChapter), [`showSpecialCmdChapter`](instructionsaction.md#showSpecialCmdChapter), [`showTimeChapter`](instructionsaction.md#showTimeChapter), [`showTipsChapter`](instructionsaction.md#showTipsChapter), [`showTravelChapter`](instructionsaction.md#showTravelChapter), [`showUnknownWordsChapter`](instructionsaction.md#showUnknownWordsChapter)
