...
*class* — defined in [parser.t](../by-file/parser.t.md) (line 2738)


**Superclass chain:** [PossessivePronounNounProd](possessivepronounnounprod.md) > [PronounProd](pronounprod.md) > [NounPhraseProd](nounphraseprod.md) > [BasicProd](basicprod.md) > `object` > **HisNounProdSubclasses:** [possessiveNounPhrase(his)](possessivenounphrase%28his%29.md)
