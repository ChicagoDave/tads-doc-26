# inventorySmellLister

*object* — defined in [lister.t](../by-file/lister.t.md) (line 1862)


Inventory lister for things that can be smelled.


**Superclass chain:** [SenseLister](senselister.md) > [ParagraphLister](paragraphlister.md) > [Lister](lister.md) > `object` > **inventorySmellLister**
...
*From [SenseLister](senselister.md):* [`isListed`](senselister.md#isListed), [`showListItemCounted`](senselister.md#showListItemCounted)
