...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10495)


set up the empty indirect object phrase


**Superclass chain:** [DetachFromAction](detachfromaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(DetachFrom)**
...
Defined in en_us.t, line 10499


### `verbPhrase`

Defined in en_us.t, line 10498
