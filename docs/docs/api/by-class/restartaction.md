...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 583)


Restart the game from the beginning.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **RestartActionSubclasses:** [predicate(Restart)](predicate%28restart%29.md)
