...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 1918)


Include objects that are directly in the actor's location, or within fixed items in the actor's location, or directly in the actor's inventory.


**Superclass chain:** [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **PutOnActionSubclasses:** [predicate(PutOn)](predicate%28puton%29.md)
...
Defined in actions.t, line 1920
...
Defined in actions.t, line 1923
