...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10636)


**Superclass chain:** [BoardAction](boardaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(Board)**
...
Defined in en_us.t, line 10643


### `verbPhrase`

Defined in en_us.t, line 10642
