...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10041)


**Superclass chain:** [GoThroughAction](gothroughaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(GoThrough)**
...
Defined in en_us.t, line 10046


### `verbPhrase`

Defined in en_us.t, line 10045
