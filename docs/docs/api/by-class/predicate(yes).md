...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9575)


**Superclass chain:** [YesAction](yesaction.md) > [ConvIAction](conviaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Yes)**
...
*From [YesAction](yesaction.md):* [`execAction`](yesaction.md#execAction)
