...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10099)


**Superclass chain:** [JumpOverAction](jumpoveraction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(JumpOver)**
...
Defined in en_us.t, line 10103


### `verbPhrase`

Defined in en_us.t, line 10102
