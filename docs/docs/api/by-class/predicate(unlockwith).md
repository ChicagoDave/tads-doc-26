...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10541)


**Superclass chain:** [UnlockWithAction](unlockwithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(UnlockWith)**
...
Defined in en_us.t, line 10546


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10547


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10545


### `verbPhrase`

Defined in en_us.t, line 10544


## Inherited Properties


*From [UnlockWithAction](unlockwithaction.md):* [`resolveFirst`](unlockwithaction.md#resolveFirst)
...
*From [UnlockWithAction](unlockwithaction.md):* [`getAllIobj`](unlockwithaction.md#getAllIobj)
