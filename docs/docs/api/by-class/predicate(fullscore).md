...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9829)


**Superclass chain:** [FullScoreAction](fullscoreaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(FullScore)**
...
Defined in en_us.t, line 9832


## Inherited Properties


*From [FullScoreAction](fullscoreaction.md):* [`includeInUndo`](fullscoreaction.md#includeInUndo)
...
*From [FullScoreAction](fullscoreaction.md):* [`execSystemAction`](fullscoreaction.md#execSystemAction), [`showFullScore`](fullscoreaction.md#showFullScore)
