...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 19)


Special "debug" action - this simply breaks into the debugger, if the debugger is present.


**Superclass chain:** [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **DebugAction**
