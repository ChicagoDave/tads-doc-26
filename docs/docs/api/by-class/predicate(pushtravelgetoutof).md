...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10765)


**Superclass chain:** [PushTravelGetOutOfAction](pushtravelgetoutofaction.md) > [PushTravelViaIobjAction](pushtravelviaiobjaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > [PushTravelAction](pushtravelaction.md) > **predicate(PushTravelGetOutOf)**
...
*From [PushTravelGetOutOfAction](pushtravelgetoutofaction.md):* [`performTravel`](pushtravelgetoutofaction.md#performTravel)
