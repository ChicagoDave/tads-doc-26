...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3695)


**Superclass chain:** [DefaultTopic](defaulttopic.md) > [TopicEntry](topicentry.md) > `object` > **DefaultTellTopic**
...
Defined in actor.t, line 3696


### `matchScore` *(overridden)*

Defined in actor.t, line 3697
