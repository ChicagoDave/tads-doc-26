...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 9895)


**Superclass chain:** [PauseAction](pauseaction.md) > [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **predicate(Pause)**
...
*From [PauseAction](pauseaction.md):* [`execSystemAction`](pauseaction.md#execSystemAction)
