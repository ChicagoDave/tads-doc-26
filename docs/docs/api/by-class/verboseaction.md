...
*class* — defined in [actions.t](../by-file/actions.t.md) (line 920)


Change to VERBOSE mode.


**Superclass chain:** [SystemAction](systemaction.md) > [IAction](iaction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > **VerboseActionSubclasses:** [predicate(Verbose)](predicate%28verbose%29.md)
