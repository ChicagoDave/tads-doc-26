...
*grammar* — defined in [en_us.t](../by-file/en_us.t.md) (line 10132)


**Superclass chain:** [MoveWithAction](movewithaction.md) > [TIAction](tiaction.md) > [TAction](taction.md) > [Action](action.md) > [BasicProd](basicprod.md) > `object` > [Resolver](resolver.md) > **predicate(MoveWith)**
...
Defined in en_us.t, line 10136


### `askIobjResponseProd` *(overridden)*

Defined in en_us.t, line 10137


### `omitIobjInDobjQuery` *(overridden)*

Defined in en_us.t, line 10138


### `verbPhrase`

Defined in en_us.t, line 10135
...
*From [MoveWithAction](movewithaction.md):* [`getAllIobj`](movewithaction.md#getAllIobj)
