...
*class* — defined in [actor.t](../by-file/actor.t.md) (line 3120)


A SHOW TO topic database entry. This type of topic entry is included in the SHOW TO list only.


**Superclass chain:** [GiveShowTopic](giveshowtopic.md) > [ThingMatchTopic](thingmatchtopic.md) > [TopicEntry](topicentry.md) > `object` > **ShowTopic**
...
*From [ThingMatchTopic](thingmatchtopic.md):* [`isMatchPossible`](thingmatchtopic.md#isMatchPossible), [`matchTopic`](thingmatchtopic.md#matchTopic), [`setTopicPronouns`](thingmatchtopic.md#setTopicPronouns)
