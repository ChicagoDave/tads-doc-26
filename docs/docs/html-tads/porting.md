...
- PNG (Portable Network Graphics).  This library provides support
  ...
  [http://www.cdrom.com/pub/png/](http://www.cdrom.com/pub/png/).  I'm currently using libpng version 0.95 (also known as 1.0
...
- ZLIB, a data-compression library.  HTML TADS doesn't use ZLIB
  ...
  [http://www.cdrom.com/pub/infozip/zlib/](http://www.cdrom.com/pub/infozip/zlib/); this page has links to
  the C source code.
...
- Libmng (the reference MNG library), at [libmng.com](http://www.libmng.com).
