...
**Image File, Load Image, Program Image:** These terms refer to
...
**User Code, Byte Code:**  These terms are used to refer to code
...
**Host Application Environment:**  The T3 VM is not a stand-alone
...
**Objects and TADS Objects:**  The T3 VM has two types of
