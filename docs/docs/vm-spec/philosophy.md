...
so much memory (proportional to the set of all *possible* items
...
**Memory usage:** The T3 VM attempts to use memory efficiently,
...
**Execution speed:**  We are willing to accept some amount of
