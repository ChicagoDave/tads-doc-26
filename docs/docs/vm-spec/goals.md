...
The T3 virtual machine does *not* specify anything about the
...
**Fast loading**: The final compiled and linked "game file"
...
**Simple save and restore**: The object model should make it
...
**Simple restart**:  The object model should make it simple and
fast to restore the initial state of the entire machine.


**Undo**:  The object model should allow changes to objects to
...
**Run-time typing**: In order to support a very high-level language
...
**TADS object model**: This is one of the few features of the
...
**Small machine portability**: If possible, 16-bit machines should
...
*Note that the new VM specification actually does incorporate
...
**Garbage collection**: The VM should provide automatic collection
...
**Exceptions**: The TADS 2 VM had a notion of exceptions, but
...
**Dictionary type**: It may be desirable to include a dictionary
