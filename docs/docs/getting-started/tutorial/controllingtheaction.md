...
The [verify()](verify.md), [check()](check.md), [action()](action.md) and [preCondition](precond.md) methods are described in some detail in the articles "[How to Create Verbs in TADS 3](../../library/actions/creating-verbs.md)", "[TADS 3 Action results](../../library/actions/action-results.md)" and "[On good usage of verify() and check() in TADS 3 games](../../library/actions/verify-check.md)" in the *Technical Manual*. These are all articles you will want to read sooner rather than later; you might find it particularly useful to read the "TADS 3 Actions results" article at the end of this chapter if you want more help on the ground we're about to cover.
