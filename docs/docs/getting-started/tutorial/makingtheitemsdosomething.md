...
|  | ```tads3   actionDobjTake() ``` |  |
|---|---|---|

|  | ```tads3   { ``` |  |
|---|---|---|

|  | ```tads3     if (location != pedestal ||       /* am I off the pedestal? */ ``` |  |
|---|---|---|

|  | ```tads3     smallRock.location == pedestal )  /* or is the rock there? */ ``` |  |
|---|---|---|

|  | ```tads3       inherited;                      /* yes - take as usual */ ``` |  |
|---|---|---|

|  | ```tads3     else                              /* no - the trap goes off! */ ``` |  |
|---|---|---|

|  | ```tads3     { ``` |  |
|---|---|---|

|  | ```tads3       "As you lift the skull, a volley ``` |  |
|---|---|---|

|  | ```tads3       of poisonous arrows is shot from ``` |  |
|---|---|---|

|  | ```tads3       the walls! You try to dodge the ``` |  |
|---|---|---|

|  | ```tads3       arrows, but they take you by surprise!"; ``` |  |
|---|---|---|

|  | ```tads3       finishGameMsg(ftDeath, [finishOptionUndo]); ``` |  |
|---|---|---|
