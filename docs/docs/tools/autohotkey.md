...
The above examples all used the Win key as an element of the hotkey combination, but plenty of other keys can be defined for the purpose. For the full list consult the AutoHotKey help file or visit [http://www.autohotkey.com/docs/Hotkeys.htm](http://www.autohotkey.com/docs/Hotkeys.htm#Symbols)
