# Creating a TADS Game, Step-by-Step
...
Do **not** put your source file in the same folder as the TADS
...
- Your game will start, and you can type commands into the game.
...
After you make changes, you must first save the file, then
...
If you have a separate text editor program that you'd prefer to
