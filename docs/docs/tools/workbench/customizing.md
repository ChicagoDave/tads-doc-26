...
Workbench offers a number of option settings that let you customize
...
Workbench has a system that lets you change the keyboard layout to
...
Use the Keyboard page of the Options dialog to define custom keys.
You can change any of the default key bindings and you can add new
bindings of your own.


Refer to [Workbench Commands](commands.md) for a complete
...
Workbench defines a number of "contexts" for keyboard commands.
...
In the keyboard customization dialog, the context for an existing
...
This means that Ctrl+F5 (i.e., the F5 key pressed while the Ctrl
...
This means that Ctrl+F5 is bound in the Global context to the
...
You'll find a couple of pre-defined key layout files in the
...
Workbench provides several toolbars, grouping related commands in
...
You can also hide toolbars entirely, if you'd prefer to free up
...
Most of the tool windows are only useful (or mostly useful) in one
...
For your convenience, Workbench can automatically show and hide
